...
var Ms = (e, o) => () => (o || e((o = { exports: {} }).exports, o), o.exports),
  Os = (e, o) => {
    for (var t in o) eo(e, t, { get: o[t], enumerable: !0 });
  },
  Tt = (e, o, t, n) => {
    if ((o && typeof o == "object") || typeof o == "function")
      for (let r of $s(o))
        !Ss.call(e, r) &&
          ...
          eo(e, r, {
            get: () => o[r],
            enumerable: !(n = Ds(o, r)) || n.enumerable,
          });
    return e;
  };
var Bs = (e, o, t) => (
    ...
    Tt(
      o || !e || !e.__esModule
        ? eo(t, "default", { value: e, enumerable: !0 })
        : t,
      e,
    )
  ),
  Rs = (e) => Tt(eo({}, "__esModule", { value: !0 }), e);
var ns = Ms((Zx, ts) => {
  "use strict";
  ts.exports = function e(o, t) {
    if (o === t) return !0;
    if (o && t && typeof o == "object" && typeof t == "object") {
      if (o.constructor !== t.constructor) return !1;
      var n, r, s;
      if (Array.isArray(o)) {
        if (((n = o.length), n != t.length)) return !1;
        for (r = n; r-- !== 0; ) if (!e(o[r], t[r])) return !1;
        return !0;
      }
      if (o.constructor === RegExp)
        return o.source === t.source && o.flags === t.flags;
      if (o.valueOf !== Object.prototype.valueOf)
        return o.valueOf() === t.valueOf();
      if (o.toString !== Object.prototype.toString)
        return o.toString() === t.toString();
      if (((s = Object.keys(o)), (n = s.length), n !== Object.keys(t).length))
        return !1;
      for (r = n; r-- !== 0; )
...
var bc = {};
Os(bc, { activate: () => uc, deactivate: () => hc });
module.exports = Rs(bc);
var To = require("vscode");
var oo = (e, o) => {
    let t = o
        .replace(/\[(\w+)\]/g, ".$1")
        .replace(/^\./, "")
  ...
  to = (e, o, t) => {
    var n;
    if ((typeof o == "string" && (o = o.split(".")), o.length > 1)) {
      let r = (n = o.shift()) != null ? n : "";
      to(
        (e[r] =
          Object.prototype.toString.call(e[r]) === "[object Object]"
            ? e[r]
            : {}),
        o,
        t,
  ...
  _ = (...e) =>
    e.reduce(
      (o, t) => (
        Object.keys(t != null ? t : {}).forEach((n) => {
          let r = o[n],
            s = t == null ? void 0 : t[n];
          r == null && s !== void 0 && s !== null
            ? (o[n] = s)
            : (s == null && r !== void 0 && r !== null) ||
              (Array.isArray(s) && Array.isArray(r)
                ? (o[n] = [...new Set(r.concat(s))])
                : typeof s == "object" &&
                    s !== null &&
                    typeof r == "object" &&
                    r !== null
...
var $o = "#90a4ae",
  Y = () => ({
    ...
    rootFolders: { color: $o, associations: {} },
    activeIconPack: "angular",
    hidesExplorerArrows: !1,
    opacity: 1,
    saturation: 1,
    files: { color: $o, associations: {}, customClones: [] },
    languages: { associations: {}, customClones: [] },
    enableLogging: !1,
    logLevel: "info",
  }),
  be = (e) => _(Y(), e != null ? e : {});
var Dt = { debug: 1, info: 2, error: 3 },
  Lo = new Set(),
  Vs = () => {
    let e = (o, t) => {
      let n = new Date().toISOString(),
        r = { level: o, message: `[${o.toUpperCase()}] ${n} - ${t}` };
      for (let s of Lo) s(r);
    };
    return {
      info: (o) => e("info", o),
  ...
  y = Vs();
var ce = (e) => {
    var o, t, n, r, s, a, i, l, c, f, g, d, h, j, I, k, w;
    try {
      let D = Y(),
        $ = "";
      return (
        (e.saturation !== D.saturation ||
          e.opacity !== D.opacity ||
          ((o = e.files) == null ? void 0 : o.color) !== D.files.color ||
          ((t = e.folders) == null ? void 0 : t.color) !== D.folders.color ||
          ((n = e.rootFolders) == null ? void 0 : n.color) !==
            D.rootFolders.color ||
          ((a =
            (s = (r = e.files) == null ? void 0 : r.customClones) == null
              ? void 0
              : s.length) != null
            ? a
            : 0) > 0 ||
          ((c =
            (l = (i = e.folders) == null ? void 0 : i.customClones) == null
              ? void 0
              : l.length) != null
            ? c
            : 0) > 0 ||
          ((d =
            (g = (f = e.languages) == null ? void 0 : f.customClones) == null
              ? void 0
              : g.length) != null
            ? d
            : 0) > 0) &&
          ($ += `~${qs(JSON.stringify({ saturation: e.saturation, opacity: e.opacity, foldersColor: (h = e.folders) == null ? void 0 : h.color, rootFoldersColor: (j = e.rootFolders) == null ? void 0 : j.color, filesColor: (I = e.files) == null ? void 0 : I.color, fileClones: (k = e.files) == null ? void 0 : k.customClones, folderClones: (w = e.folders) == null ? void 0 : w.customClones }))}`),
        $
      );
    } catch (D) {
      return (y.error(D), "");
  ...
  qs = (e) => {
    ...
    for (let n = 0; n < e.length; n++)
      ((t = e.charCodeAt(n)), (o = (o << 5) - o + t), (o |= 0));
    return o;
  };
var W = "material-icon-theme",
  Mo = "PKief",
  Hs = `${W}-log-event`,
  H = "./../icons/",
  Oo = "material-icons.json",
  ee = "-open",
  M = "_light",
  Z = "_highContrast",
  je = ".clone.svg",
...
var Gt = require("path");
var Lt = require("path"),
  S = (...e) => (0, Lt.join)(__dirname, "..", "..", ...e);
var St = require("fs/promises");
var ae = async (e, o, t) => {
  if (!e || !o || o.trim().length === 0) {
    y.error("Invalid file path or data to write! File path: " + e);
    return;
  }
  (y.debug("Writing to file: " + e), await (0, St.writeFile)(e, o, t));
};
var ve = require("fs/promises"),
  Bt = require("path");
var Mt = require("path");
var _e = (e = {}) =>
  Object.values(e)
    .filter((o) => o.match(/^[.\/]+/))
    .map((o) => (0, Mt.dirname)(S(o)));
var Rt = async (e, o) => {
    if (!ro(e))
      return y.error(
        "Invalid opacity value! Opacity must be a decimal number between 0 and 1!",
      );
    y.info(`Setting opacity to ${e}...`);
    let t = S(H),
      n = _e(o),
      r = await (0, ve.readdir)(t);
    try {
      for (let s of r) await Ot(t, s, e);
      for (let s of n) {
        let a = await (0, ve.readdir)(s);
        for (let i of a) await Ot(s, i, e);
      }
    } catch (s) {
      y.error(s);
    }
  },
  ro = (e) => e !== void 0 && e <= 1 && e >= 0,
  Gs = (e) => {
    let o = new RegExp(/<svg[^>]*>/).exec(e);
    return o == null ? void 0 : o[0];
  },
  Ws = (e, o) => {
    let t = new RegExp(/\sopacity="[\d.]+"/);
    return t.test(e)
      ? e.replace(t, ` opacity="${o}"`)
      : e.replace(/^<svg/, `<svg opacity="${o}"`);
  },
  Xs = (e) => {
    let o = new RegExp(/\sopacity="[\d.]+"/);
    return e.replace(o, "");
  },
  Bo = (e, o) => {
    let t = Gs(e);
    if (!t) return e;
    let n;
    return (o < 1 ? (n = Ws(t, o)) : (n = Xs(t)), e.replace(/<svg[^>]*>/, n));
  },
  Ot = async (e, o, t) => {
    let n = (0, Bt.join)(e, o);
    if (!(await (0, ve.lstat)(n)).isFile()) return;
    let r = await (0, ve.readFile)(n, "utf-8"),
      s = Bo(r, t);
    s.trim().length !== 0 && (await ae(n, s));
  };
var Ne = require("fs/promises"),
  qt = require("path");
var Ht = async (e, o) => {
    if (!so(e))
      return y.error(
    ...
    y.info(`Setting saturation to ${e}...`);
    let t = S(H),
      n = _e(o),
      r = await (0, Ne.readdir)(t);
    try {
      for (let s of r) await Vt(t, s, e);
      for (let s of n) {
        let a = await (0, Ne.readdir)(s);
        for (let i of a) await Vt(s, i, e);
      }
    } catch (s) {
      y.error(s);
    }
  ...
  Ys = (e) => {
    let o = new RegExp(/\sfilter="[^"]+?"/);
    return o.test(e)
      ? e.replace(o, ' filter="url(#saturation)"')
  ...
  Ks = (e, o) => {
    let t = new RegExp(/<filter id="saturation".+<\/filter>(.*<\/svg>)/),
      n = `<filter id="saturation"><feColorMatrix type="saturate" values="${o}"/></filter>`;
    return t.test(e)
      ? e.replace(t, `${n}$1`)
      : e.replace(/<\/svg>/, `${n}</svg>`);
  },
  Us = (e) => {
    let o = new RegExp(/<filter id="saturation".+<\/filter>(.*<\/svg>)/);
    return e.replace(o, "$1");
  },
  so = (e) => e !== void 0 && e <= 1 && e >= 0,
  Ro = (e, o) => {
    let t = Qs(e);
    if (!t) return e;
    let n;
    o < 1 ? (n = Ys(t)) : (n = Zs(t));
    let r = e.replace(/<svg[^>]*>/, n);
    return (o < 1 ? (r = Ks(r, o)) : (r = Us(r)), r);
  },
  Vt = async (e, o, t) => {
    let n = (0, qt.join)(e, o);
    if (!(await (0, Ne.lstat)(n)).isFile()) return;
    let r = await (0, Ne.readFile)(n, "utf-8"),
      s = Ro(r, t);
    await ae(n, s);
  };
var Ce = async (e, o, t, n) => {
    let r = Bo(o, t),
      s = Ro(r, n),
      a = S(H),
      i = (0, Gt.join)(a, `${e}.svg`);
  ...
  Ge = (e, o) => `<path d="${e}" fill="${o}" />`,
  Fe = (e, o = 16) =>
    `<svg viewBox="0 0 ${o} ${o}" xmlns="http://www.w3.org/2000/svg">${e}</svg>`;
var me = (e = "") => {
  let o = new RegExp(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/);
  return e.length > 0 && o.test(e);
};
var Xt = (e, o, t) => {
    var i;
    let n = Js(e, o.activeIconPack),
      r = ea((i = o.files) == null ? void 0 : i.associations),
      s = [...e.icons, ...r],
      a = [...n, ...r];
    return (
      s.forEach((l) => {
        let c = l.clone !== void 0;
        ((t = Te(t, o, l.name, c)),
          l.light && (t = Te(t, o, l.name, c, M)),
          l.highContrast && (t = Te(t, o, l.name, c, Z)));
      }),
      a.forEach((l) => {
        var c;
        l.disabled ||
          (l.fileExtensions && (t = Wt(l, "fileExtensions", t)),
          l.fileNames &&
            (t = Wt(
              l,
              "fileNames",
              t,
              (c = o.files) == null ? void 0 : c.associations,
            )));
      }),
      (t = Te(t, o, e.defaultIcon.name, !1)),
      (t.file = e.defaultIcon.name),
      e.defaultIcon.light &&
        t.light &&
        ((t = Te(t, o, e.defaultIcon.name, !1, M)),
        t.light && (t.light.file = e.defaultIcon.name + M)),
      e.defaultIcon.highContrast &&
        ((t = Te(t, o, e.defaultIcon.name, !1, Z)),
        t.highContrast && (t.highContrast.file = e.defaultIcon.name + Z)),
      t
    );
  },
  Wt = (e, o, t, n = {}) => {
    ...
    return (
      r === void 0 ||
        r.forEach((s) => {
          var f, g;
          let a = Object.keys(n).some((d) => {
              if (!/^\*{2}\./.test(d)) return !1;
              let h = d.replace(no, ".");
              return s.toLowerCase().indexOf(h.toLowerCase()) !== -1;
            }),
            i = t[o],
            l = (f = t.light) == null ? void 0 : f[o],
            c = (g = t.highContrast) == null ? void 0 : g[o];
          a ||
            !i ||
            !l ||
            !c ||
            ((i[s] = e.name),
            e.light && (l[s] = `${e.name}${M}`),
            e.highContrast && (c[s] = `${e.name}${Z}`));
        }),
      t
    );
  },
  Js = (e, o) =>
    e.icons.filter((t) =>
      t.enabledFor ? t.enabledFor.some((n) => n === o) : !0,
    ),
  Te = (e, o, t, n, r = "") => {
    var i;
    let s = n ? je : ".svg",
      a = `${t}${r}`;
    if (
      ((i = e.iconDefinitions) != null || (e.iconDefinitions = {}),
      !e.iconDefinitions[a])
    ) {
      let l = ce(o);
      e.iconDefinitions[a] = { iconPath: `${H}${t}${r}${l}${s}` };
    }
    return e;
  },
  Qt = async (e, o, t) => {
    if (!e || !me(e)) return y.error("Invalid color code for file icons");
    await Ce(
      "file",
      Fe(
        Ge(
  ...
  ea = (e) =>
    e
      ? Object.keys(e).map((t) => {
          let n = { name: e[t].toLowerCase() };
          return (
            no.test(t)
              ? (n.fileExtensions = [t.toLowerCase().replace(no, "")])
...
var Kt = (e, o, t) => {
    var l, c, f, g, d;
    t.hidesExplorerArrows = o.hidesExplorerArrows;
    let n = ta(e, (l = o.folders) == null ? void 0 : l.theme);
    if (!n) return t;
    let r = na(n, o.activeIconPack),
      s = [
        ...Zt((c = o.folders) == null ? void 0 : c.associations, !1),
        ...Zt((f = o.rootFolders) == null ? void 0 : f.associations, !0),
      ],
      a = [...((g = n.icons) != null ? g : []), ...s],
      i = [...r, ...s];
    return (
      ((d = o.folders) == null ? void 0 : d.theme) === "none" ||
        (a.forEach((h) => {
          t = Wo(t, o, h);
        }),
        i.forEach((h) => {
          ...
          let j = Yt((k = h == null ? void 0 : h.folderNames) != null ? k : []),
            I = Yt(
              (w = h == null ? void 0 : h.rootFolderNames) != null ? w : [],
            );
          ((t = _(t, qo(h.name, j, I))),
            (t.light = h.light ? _(t.light, qo(h.name, j, I, M)) : t.light),
            (t.highContrast = h.highContrast
              ? _(t.highContrast, qo(h.name, j, I, Z))
              : t.highContrast));
        }),
        (t = oa(n, t, o))),
      t
  ...
  oa = (e, o, t) => {
    let n = !!e.defaultIcon.name && e.defaultIcon.name.length > 0;
    return (
      n && (o = Wo(o, t, e.defaultIcon)),
      (o = _(o, Ho(n, e, ""))),
      (o.light = e.defaultIcon.light ? _(o.light, Ho(n, e, M)) : o.light),
      (o.highContrast = e.defaultIcon.highContrast
        ? _(o.highContrast, Ho(n, e, Z))
        : o.highContrast),
      (o = _(o, Go(n, e, ""))),
      e.rootFolder &&
        ((o = Wo(o, t, e.rootFolder)),
        (o.light = e.rootFolder.light ? _(o.light, Go(n, e, M)) : o.light),
        (o.highContrast = e.rootFolder.highContrast
          ? _(o.highContrast, Go(n, e, Z))
          : o.highContrast)),
      o
    );
  },
  ta = (e, o) => e.find((t) => t.name === o),
  na = (e, o) =>
    !(e != null && e.icons) || e.icons.length === 0
      ? []
      : e.icons.filter((t) =>
          t.enabledFor ? t.enabledFor.some((n) => n === o) : !0,
        ),
  Wo = (e, o, t) => {
    let n = t.clone !== void 0;
    return (
      (e = Vo(e, o, t.name, "", n)),
      t.light && (e = _(e, Vo(e, o, t.name, M, n))),
      t.highContrast && (e = _(e, Vo(e, o, t.name, Z, n))),
      e
    );
  },
  Vo = (e, o, t, n = "", r = !1) => {
    ...
    return (
      a &&
        (a[l] || (a[l] = { iconPath: `${H}${l}${s}${i}` }),
        a[`${c}`] || (a[`${c}`] = { iconPath: `${H}${c}${s}${i}` })),
      e
    );
  },
  Yt = (e) => {
  ...
  qo = (e, o, t, n = "") => {
    let r = (i) => {
        ...
        return (
          ...
          { regular: l, expanded: c }
        );
      },
      s = r(o),
      a = r(t);
    return {
      folderNames: s.regular,
      folderNamesExpanded: s.expanded,
      rootFolderNames: a.regular,
      rootFolderNamesExpanded: a.expanded,
    };
  },
  Ho = (e, o, t = "") => {
    let n = { folder: "", folderExpanded: "" };
    return (
      (n.folder = e ? o.defaultIcon.name + t : ""),
      (n.folderExpanded = e ? `${o.defaultIcon.name}${ee}${t}` : ""),
      n
    );
  },
  Go = (e, o, t = "") => {
    let n = { rootFolder: "", rootFolderExpanded: "" };
    return (
      (n.rootFolder = e
        ? o.rootFolder
          ? o.rootFolder.name + t
          : o.defaultIcon.name + t
        : ""),
      (n.rootFolderExpanded = e
        ? o.rootFolder
          ? `${o.rootFolder.name}${ee}${t}`
          : `${o.defaultIcon.name}${ee}${t}`
        : ""),
      n
    );
  },
  Zt = (e, o) =>
    e
      ? Object.entries(e).map(([t, n]) => {
          let r = {
              name: n ? `folder-${n.toLowerCase()}` : "folder",
              folderNames: [],
              rootFolderNames: [],
            },
            s = o ? "rootFolderNames" : "folderNames";
          return ((r[s] = [t.toLowerCase()]), r);
        })
      : [],
  Ut = async (e, o, t) => {
    if (!e || !me(e)) return y.error("Invalid color code for folder icons");
    let n =
    ...
    (await Ce("folder", Fe(Ge(n, e)), o, t),
      await Ce("folder-open", Fe(Ge(r, e)), o, t));
  },
  Jt = async (e, o, t) => {
    if (!e || !me(e))
      return y.error("Invalid color code for root folder icons");
    let n = `<circle cx="8" cy="8" r="6" fill="none" stroke="${e}" stroke-width="2"/>`,
      r = `<circle cx="8" cy="8" r="3" fill="${e}"/>`;
    (await Ce("folder-root", Fe(n + r), o, t),
      await Ce("folder-root-open", Fe(n), o, t));
  };
var Xo = async (e, o) => {
  (e.files.color !== o.files.color &&
    (await Qt(e.files.color, e.opacity, e.saturation)),
    e.folders.color !== o.folders.color &&
      (await Ut(e.folders.color, e.opacity, e.saturation)),
    e.rootFolders.color !== o.rootFolders.color &&
      (await Jt(e.rootFolders.color, e.opacity, e.saturation)),
    e.opacity !== o.opacity && (await Rt(e.opacity, e.files.associations)),
    e.saturation !== o.saturation &&
      (await Ht(e.saturation, e.files.associations)));
};
var en = require("fs"),
  io = require("fs/promises"),
  xe = require("path");
var ao = (e) =>
    (e == null ? void 0 : e.folderNames) !== void 0 ||
    (e == null ? void 0 : e.rootFolderNames) !== void 0,
  on = (e) => e && e.ids !== void 0,
  ra = (e) => e.variant === 0 || e.variant === 1,
  tn = (e, o, t, n, r) => {
    let s = ao(e) ? ia(e, o) : sa(e, o);
    if (s)
      return s.map((a) => {
        var l;
        let i = ao(e) ? la(a, e, n, t, r) : aa(a, e, n, t, r);
        return {
          name: Yo(e.name, a),
          color: ra(a) ? e.color : (l = e.lightColor) != null ? l : e.color,
          inConfigPath: `${H}${t}${(0, xe.basename)(i.path)}`,
          base: a,
          ...i,
        };
      });
  ...
  sa = (e, o) => {
    ...
    let t = [],
      n =
        (a = (s = o.iconDefinitions) == null ? void 0 : s[`${e.base}`]) == null
          ? void 0
          : a.iconPath,
      r =
        (l = (i = o.iconDefinitions) == null ? void 0 : i[`${e.base}${M}`]) ==
        null
          ? void 0
          : l.iconPath;
    if ((e.lightColor && !r && (r = n), n))
      return (
        t.push({ type: 1, variant: 0, path: S(n) }),
        r && t.push({ type: 1, variant: 2, path: S(r) }),
        t
      );
  },
  aa = (e, o, t, n, r = ".svg") => {
    let s = Yo(o.name, e),
      a = (0, xe.join)((0, xe.dirname)(e.path), n, `${s}${t}${r}`);
    return { variant: e.variant, type: e.type, path: a };
  },
  ia = (e, o) => {
    var l, c, f, g, d, h, j, I;
    let t = [],
      n =
        e.base === "folder"
          ? "folder"
          : e.base.startsWith("folder-")
            ? e.base
            : `folder-${e.base}`,
      r =
        (c = (l = o.iconDefinitions) == null ? void 0 : l[`${n}`]) == null
          ? void 0
          : c.iconPath,
      s =
        (g = (f = o.iconDefinitions) == null ? void 0 : f[`${n}${ee}`]) == null
          ? void 0
          : g.iconPath,
      a =
        (h = (d = o.iconDefinitions) == null ? void 0 : d[`${n}${M}`]) == null
          ? void 0
          : h.iconPath,
      i =
        (I = (j = o.iconDefinitions) == null ? void 0 : j[`${n}${ee}${M}`]) ==
        null
          ? void 0
          : I.iconPath;
    if (r && s)
      return (
        t.push({ type: 0, variant: 0, path: S(r) }),
        t.push({ type: 0, variant: 1, path: S(s) }),
        e.lightColor && (!a || !i) && ((a = r), (i = s)),
        a && t.push({ type: 0, variant: 2, path: S(a) }),
        i && t.push({ type: 0, variant: 3, path: S(i) }),
        t
      );
  },
  la = (e, o, t, n, r = ".svg") => {
    let s = Yo(o.name, e),
      a = (0, xe.join)((0, xe.dirname)(e.path), n, `${s}${t}${r}`);
    return { type: e.type, variant: e.variant, path: a };
  },
  Qo = async (e = !0) => {
    let o = S("./../icons/clones");
    ((0, en.existsSync)(o) && (await (0, io.rm)(o, { recursive: !0 })),
      e && (await (0, io.mkdir)(o)));
  },
  Yo = (e, o) => {
    let t = "",
      n = "";
    if (o.type === 0)
      switch (
        ((t = e === "folder" || e.startsWith("folder-") ? "" : "folder-"),
        o.variant)
      ) {
        case 0:
          break;
    ...
    else n = o.variant === 2 ? M : "";
    return `${t}${e}${n}`;
  };
var ut = require("fs/promises");
var { min: ca, max: ma } = Math,
  oe = (e, o = 0, t = 1) => ca(ma(o, e), t);
var Ie = (e) => {
  ((e._clipped = !1), (e._unclipped = e.slice(0)));
  for (let o = 0; o <= 3; o++)
    o < 3
      ? ((e[o] < 0 || e[o] > 255) && (e._clipped = !0),
        (e[o] = oe(e[o], 0, 255)))
      : o === 3 && (e[o] = oe(e[o], 0, 1));
  return e;
};
...
for (let e of [
  ...
  nn[`[object ${e}]`] = e.toLowerCase();
function b(e) {
  return nn[Object.prototype.toString.call(e)] || "object";
}
var u = (e, o = null) =>
  e.length >= 3
    ...
    : b(e[0]) == "object" && o
      ? o
          .split("")
          .filter((t) => e[0][t] !== void 0)
          .map((t) => e[0][t])
      : e[0].slice(0);
var U = (e) => {
  if (e.length < 2) return null;
  let o = e.length - 1;
  return b(e[o]) == "string" ? e[o].toLowerCase() : null;
};
var { PI: lo, min: co, max: mo } = Math,
  G = (e) => Math.round(e * 100) / 100,
  We = (e) => Math.round(e * 100) / 100,
  te = lo * 2,
  fo = lo / 3,
  rn = lo / 180,
  sn = 180 / lo;
...
var Zo = class {
    constructor(...o) {
      ...
      if (!n) {
        ((r = !0),
          x.sorted ||
            ((x.autodetect = x.autodetect.sort((s, a) => a.p - s.p)),
            (x.sorted = !0)));
        for (let s of x.autodetect) if (((n = s.test(...o)), n)) break;
      }
      if (x.format[n]) {
        let s = x.format[n].apply(null, r ? o : o.slice(0, -1));
        t._rgb = Ie(s);
      } else throw new Error("unknown format: " + o);
      t._rgb.length === 3 && t._rgb.push(1);
    }
    toString() {
      return b(this.hex) == "function"
        ? this.hex()
        : `[${this._rgb.join(",")}]`;
    }
  },
...
var fa = {
  ...
  ye = fa;
var da = /^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,
  pa = /^#?([A-Fa-f0-9]{8}|[A-Fa-f0-9]{4})$/,
  ga = (e) => {
    if (e.match(da)) {
    ...
    if (e.match(pa)) {
      ...
      let o = parseInt(e, 16),
        ...
        n = (o >> 16) & 255,
        r = (o >> 8) & 255,
        s = Math.round(((o & 255) / 255) * 100) / 100;
      return [t, n, r, s];
    }
...
var { round: uo } = Math,
  ua = (...e) => {
    let [o, t, n, r] = u(e, "rgba"),
      s = U(e) || "auto";
    (r === void 0 && (r = 1),
      s === "auto" && (s = r < 1 ? "rgba" : "rgb"),
      (o = uo(o)),
      (t = uo(t)),
      (n = uo(n)));
    let i = "000000" + ((o << 16) | (t << 8) | n).toString(16);
    i = i.substr(i.length - 6);
    let l = "0" + uo(r * 255).toString(16);
...
m.prototype.name = function () {
  let e = ho(this._rgb, "rgb");
  for (let o of Object.keys(ye)) if (ye[o] === e) return o.toLowerCase();
  return e;
};
x.format.named = (e) => {
  if (((e = e.toLowerCase()), ye[e])) return go(ye[e]);
  throw new Error("unknown color name: " + e);
};
x.autodetect.push({
  p: 5,
  test: (e, ...o) => {
    if (!o.length && b(e) === "string" && ye[e.toLowerCase()]) return "named";
  },
});
m.prototype.alpha = function (e, o = !1) {
  return e !== void 0 && b(e) === "number"
    ? o
      ? ((this._rgb[3] = e), this)
      : new m([this._rgb[0], this._rgb[1], this._rgb[2], e], "rgb")
    : this._rgb[3];
};
m.prototype.clipped = function () {
...
var Xe = {
    ...
    t2: 0.12841855,
    t3: 0.008856452,
    kE: 0.008856451679035631,
    kKE: 8,
    kK: 903.2962962962963,
...
function ne(e) {
  let o = ha.get(String(e).toLowerCase());
  if (!o) throw new Error("unknown Lab illuminant " + e);
  ((Xe.labWhitePoint = e), (Xe.Xn = o[0]), (Xe.Zn = o[1]));
}
function ke() {
  return Xe.labWhitePoint;
}
var ba = (...e) => {
    e = u(e, "lab");
    let [o, t, n] = e,
      [r, s, a] = xa(o, t, n),
      [i, l, c] = Uo(r, s, a);
    return [i, l, c, e.length > 3 ? e[3] : 1];
  },
  xa = (e, o, t) => {
    let { kE: n, kK: r, kKE: s, Xn: a, Yn: i, Zn: l } = fe,
      c = (e + 16) / 116,
      f = 0.002 * o + c,
      g = c - 0.005 * t,
      d = f * f * f,
  ...
  Ko = (e) => {
    ...
    return (
      (e = Math.abs(e)),
      (e <= 0.0031308 ? e * 12.92 : 1.055 * Math.pow(e, 1 / 2.4) - 0.055) * o
    );
  },
  Uo = (e, o, t) => {
    let {
      ...
      f = i * n.m00 + l * n.m10 + c * n.m20,
      g = i * n.m01 + l * n.m11 + c * n.m21,
      d = i * n.m02 + l * n.m12 + c * n.m22,
      h = a.X * n.m00 + a.Y * n.m10 + a.Z * n.m20,
      j = a.X * n.m01 + a.Y * n.m11 + a.Z * n.m21,
      I = a.X * n.m02 + a.Y * n.m12 + a.Z * n.m22,
      k = (e * n.m00 + o * n.m10 + t * n.m20) * (h / f),
      w = (e * n.m01 + o * n.m11 + t * n.m21) * (j / g),
      D = (e * n.m02 + o * n.m12 + t * n.m22) * (I / d),
      $ = k * r.m00 + w * r.m10 + D * r.m20,
      R = k * r.m01 + w * r.m11 + D * r.m21,
      V = k * r.m02 + w * r.m12 + D * r.m22,
      K = Ko($ * s.m00 + R * s.m10 + V * s.m20),
      P = Ko($ * s.m01 + R * s.m11 + V * s.m21),
      p = Ko($ * s.m02 + R * s.m12 + V * s.m22);
    return [K * 255, P * 255, p * 255];
  },
  De = ba;
var ya = (...e) => {
  let [o, t, n, ...r] = u(e, "rgb"),
    [s, a, i] = et(o, t, n),
    [l, c, f] = ka(s, a, i);
  return [l, c, f, ...(r.length > 0 && r[0] < 1 ? [r[0]] : [])];
};
function ka(e, o, t) {
  let { Xn: n, Yn: r, Zn: s, kE: a, kK: i } = fe,
    l = e / n,
    c = o / r,
    f = t / s,
    g = l > a ? Math.pow(l, 1 / 3) : (i * l + 16) / 116,
    d = c > a ? Math.pow(c, 1 / 3) : (i * c + 16) / 116,
    h = f > a ? Math.pow(f, 1 / 3) : (i * f + 16) / 116;
  return [116 * d - 16, 500 * (g - d), 200 * (d - h)];
}
function Jo(e) {
  let o = Math.sign(e);
  return (
    (e = Math.abs(e)),
    (e <= 0.04045 ? e / 12.92 : Math.pow((e + 0.055) / 1.055, 2.4)) * o
  );
}
var et = (e, o, t) => {
    ((e = Jo(e / 255)), (o = Jo(o / 255)), (t = Jo(t / 255)));
    let {
        MtxRGB2XYZ: n,
        MtxAdaptMa: r,
        MtxAdaptMaI: s,
      ...
      d = e * n.m00 + o * n.m10 + t * n.m20,
      h = e * n.m01 + o * n.m11 + t * n.m21,
      j = e * n.m02 + o * n.m12 + t * n.m22,
      I = a * r.m00 + i * r.m10 + l * r.m20,
      k = a * r.m01 + i * r.m11 + l * r.m21,
      w = a * r.m02 + i * r.m12 + l * r.m22,
      D = d * r.m00 + h * r.m10 + j * r.m20,
      $ = d * r.m01 + h * r.m11 + j * r.m21,
      R = d * r.m02 + h * r.m12 + j * r.m22;
    return (
      (D *= I / c),
      ($ *= k / f),
      (R *= w / g),
      (d = D * s.m00 + $ * s.m10 + R * s.m20),
      (h = D * s.m01 + $ * s.m11 + R * s.m21),
      (j = D * s.m02 + $ * s.m12 + R * s.m22),
      [d, h, j]
    );
  },
  $e = ya;
m.prototype.lab = function () {
  return $e(this._rgb);
};
var wa = (...e) => new m(...e, "lab");
Object.assign(E, { lab: wa, getLabWhitePoint: ke, setLabWhitePoint: ne });
x.format.lab = De;
x.autodetect.push({
  p: 2,
  test: (...e) => {
    if (((e = u(e, "lab")), b(e) === "array" && e.length === 3)) return "lab";
  },
});
m.prototype.darken = function (e = 1) {
  let o = this,
    t = o.lab();
  return ((t[0] -= fe.Kn * e), new m(t, "lab").alpha(o.alpha(), !0));
};
m.prototype.brighten = function (e = 1) {
  return this.darken(-e);
};
m.prototype.darker = m.prototype.darken;
m.prototype.brighter = m.prototype.brighten;
m.prototype.get = function (e) {
  let [o, t] = e.split("."),
    n = this[o]();
  if (t) {
    let r = o.indexOf(t) - (o.substr(0, 2) === "ok" ? 2 : 0);
    if (r > -1) return n[r];
    throw new Error(`unknown channel ${t} in mode ${o}`);
  } else return n;
};
var { pow: Ea } = Math,
  ja = 1e-7,
  va = 20;
m.prototype.luminance = function (e, o = "rgb") {
  if (e !== void 0 && b(e) === "number") {
    if (e === 0) return new m([0, 0, 0, this._rgb[3]], "rgb");
    if (e === 1) return new m([255, 255, 255, this._rgb[3]], "rgb");
    let t = this.luminance(),
      n = va,
      r = (a, i) => {
        let l = a.interpolate(i, 0.5, o),
          c = l.luminance();
        return Math.abs(e - c) < ja || !n-- ? l : c > e ? r(a, l) : r(l, i);
      },
      s = (
        t > e ? r(new m([0, 0, 0]), this) : r(this, new m([255, 255, 255]))
      ).rgb();
    return new m([...s, this._rgb[3]]);
  }
  return Na(...this._rgb.slice(0, 3));
};
var Na = (e, o, t) => (
    (e = ot(e)),
    (o = ot(o)),
    (t = ot(t)),
    0.2126 * e + 0.7152 * o + 0.0722 * t
  ),
  ot = (e) => (
    (e /= 255),
    e <= 0.03928 ? e / 12.92 : Ea((e + 0.055) / 1.055, 2.4)
  );
var T = {};
var de = (e, o, t = 0.5, ...n) => {
  let r = n[0] || "lrgb";
  if ((!T[r] && !n.length && (r = Object.keys(T)[0]), !T[r]))
    throw new Error(`interpolation mode ${r} is not defined`);
  return (
    b(e) !== "object" && (e = new m(e)),
    b(o) !== "object" && (o = new m(o)),
    T[r](e, o, t).alpha(e.alpha() + t * (o.alpha() - e.alpha()))
  );
};
m.prototype.mix = m.prototype.interpolate = function (e, o = 0.5, ...t) {
  return de(this, e, o, ...t);
};
m.prototype.premultiply = function (e = !1) {
  let o = this._rgb,
    t = o[3];
  return e
    ? ((this._rgb = [o[0] * t, o[1] * t, o[2] * t, t]), this)
    : new m([o[0] * t, o[1] * t, o[2] * t, t], "rgb");
};
var { sin: Ca, cos: Fa } = Math,
  Ia = (...e) => {
    let [o, t, n] = u(e, "lch");
    return (isNaN(n) && (n = 0), (n = n * rn), [o, Fa(n) * t, Ca(n) * t]);
  },
  bo = Ia;
var Aa = (...e) => {
    e = u(e, "lch");
...
var Pa = (...e) => {
  ...
  cn = Pa;
var { sqrt: za, atan2: _a, round: Ta } = Math,
  Da = (...e) => {
    let [o, t, n] = u(e, "lab"),
      r = za(t * t + n * n),
      s = (_a(n, t) * sn + 360) % 360;
    return (Ta(r * 1e4) === 0 && (s = Number.NaN), [o, r, s]);
  },
  xo = Da;
var $a = (...e) => {
    let [o, t, n, ...r] = u(e, "rgb"),
...
m.prototype.hcl = function () {
  return po(Qe(this._rgb));
};
var La = (...e) => new m(...e, "lch"),
  Sa = (...e) => new m(...e, "hcl");
Object.assign(E, { lch: La, hcl: Sa });
x.format.lch = Le;
x.format.hcl = cn;
["lch", "hcl"].forEach((e) =>
  x.autodetect.push({
    p: 2,
    test: (...o) => {
      if (((o = u(o, e)), b(o) === "array" && o.length === 3)) return e;
    },
  }),
);
m.prototype.saturate = function (e = 1) {
  let o = this,
    t = o.lch();
  return (
    (t[1] += fe.Kn * e),
    t[1] < 0 && (t[1] = 0),
    new m(t, "lch").alpha(o.alpha(), !0)
  );
};
m.prototype.desaturate = function (e = 1) {
  return this.saturate(-e);
};
m.prototype.set = function (e, o, t = !1) {
  let [n, r] = e.split("."),
    s = this[n]();
  if (r) {
    let a = n.indexOf(r) - (n.substr(0, 2) === "ok" ? 2 : 0);
    if (a > -1) {
      if (b(o) == "string")
        switch (o.charAt(0)) {
          case "+":
...
m.prototype.tint = function (e = 0.5, ...o) {
  return de(this, "white", e, ...o);
};
m.prototype.shade = function (e = 0.5, ...o) {
  return de(this, "black", e, ...o);
};
var Ma = (e, o, t) => {
  let n = e._rgb,
    r = o._rgb;
...
T.rgb = Ma;
var { sqrt: tt, pow: Se } = Math,
  Oa = (e, o, t) => {
    let [n, r, s] = e._rgb,
      [a, i, l] = o._rgb;
    return new m(
      tt(Se(n, 2) * (1 - t) + Se(a, 2) * t),
      tt(Se(r, 2) * (1 - t) + Se(i, 2) * t),
      tt(Se(s, 2) * (1 - t) + Se(l, 2) * t),
      "rgb",
    );
  };
T.lrgb = Oa;
    ...
    : n === "hsv"
      ...
      : n === "hcg"
        ...
        : n === "hsi"
          ? ((r = e.hsi()), (s = o.hsi()))
          : n === "lch" || n === "hcl"
            ? ((n = "hcl"), (r = e.hcl()), (s = o.hcl()))
            : n === "oklch" &&
              ((r = e.oklch().reverse()), (s = o.oklch().reverse()));
  let a, i, l, c, f, g;
  ...
  return (
    !isNaN(a) && !isNaN(i)
      ...
      : isNaN(a)
        ? isNaN(i)
          ? (h = Number.NaN)
          : ((h = i), (f == 1 || f == 0) && n != "hsv" && (d = c))
        : ((h = a), (g == 1 || g == 0) && n != "hsv" && (d = l)),
    d === void 0 && (d = l + t * (c - l)),
    (j = f + t * (g - f)),
    n === "oklch" ? new m([j, d, h], n) : new m([h, d, j], n)
  );
};
var mn = (e, o, t) => re(e, o, t, "lch");
T.lch = mn;
T.hcl = mn;
var Ra = (e) => {
    if (b(e) == "number" && e >= 0 && e <= 16777215) {
      let o = e >> 16,
        t = (e >> 8) & 255,
        n = e & 255;
      return [o, t, n, 1];
...
var qa = (...e) => new m(...e, "num");
Object.assign(E, { num: qa });
x.format.num = fn;
x.autodetect.push({
  p: 5,
  test: (...e) => {
    if (e.length === 1 && b(e[0]) === "number" && e[0] >= 0 && e[0] <= 16777215)
      return "num";
  },
});
var Ha = (e, o, t) => {
...
var Xa = (...e) => {
  ...
  gn = Xa;
m.prototype.hcg = function () {
  return gn(this._rgb);
};
var Qa = (...e) => new m(...e, "hcg");
E.hcg = Qa;
x.format.hcg = pn;
x.autodetect.push({
  p: 1,
  test: (...e) => {
    if (((e = u(e, "hcg")), b(e) === "array" && e.length === 3)) return "hcg";
  },
});
var Ya = (e, o, t) => re(e, o, t, "hcg");
T.hcg = Ya;
var { cos: Me } = Math,
  Za = (...e) => {
    e = u(e, "hsi");
    ...
    return (
      ...
      o < 1 / 3
        ? ((a = (1 - t) / 3),
          (r = (1 + (t * Me(te * o)) / Me(fo - te * o)) / 3),
          (s = 1 - (a + r)))
        : o < 2 / 3
          ? ((o -= 1 / 3),
            (r = (1 - t) / 3),
            (s = (1 + (t * Me(te * o)) / Me(fo - te * o)) / 3),
            (a = 1 - (r + s)))
          : ((o -= 2 / 3),
            (s = (1 - t) / 3),
            (a = (1 + (t * Me(te * o)) / Me(fo - te * o)) / 3),
            (r = 1 - (s + a))),
      (r = oe(n * r * 3)),
      (s = oe(n * s * 3)),
      (a = oe(n * a * 3)),
      [r * 255, s * 255, a * 255, e.length > 3 ? e[3] : 1]
    );
  },
  un = Za;
var { min: Ka, sqrt: Ua, acos: Ja } = Math,
  ei = (...e) => {
    let [o, t, n] = u(e, "rgb");
    ((o /= 255), (t /= 255), (n /= 255));
    let r,
  ...
  hn = ei;
m.prototype.hsi = function () {
  return hn(this._rgb);
};
var oi = (...e) => new m(...e, "hsi");
E.hsi = oi;
x.format.hsi = un;
x.autodetect.push({
  p: 2,
  test: (...e) => {
    if (((e = u(e, "hsi")), b(e) === "array" && e.length === 3)) return "hsi";
  },
});
var ti = (e, o, t) => re(e, o, t, "hsi");
T.hsi = ti;
var ni = (...e) => {
    e = u(e, "hsl");
    let [o, t, n] = e,
          ...
          6 * i[d] < 1
            ...
            : 2 * i[d] < 1
              ...
              : 3 * i[d] < 2
                ? (l[d] = f + (c - f) * (2 / 3 - i[d]) * 6)
                : (l[d] = f));
      [r, s, a] = [l[0] * 255, l[1] * 255, l[2] * 255];
    }
    return e.length > 3 ? [r, s, a, e[3]] : [r, s, a, 1];
  },
  Ye = ni;
var ri = (...e) => {
    e = u(e, "rgba");
    ...
    return (
      ...
      (l *= 60),
      l < 0 && (l += 360),
      e.length > 3 && e[3] !== void 0 ? [l, i, a, e[3]] : [l, i, a]
    );
  },
  yo = ri;
m.prototype.hsl = function () {
  return yo(this._rgb);
};
var si = (...e) => new m(...e, "hsl");
E.hsl = si;
x.format.hsl = Ye;
x.autodetect.push({
  p: 2,
  test: (...e) => {
    if (((e = u(e, "hsl")), b(e) === "array" && e.length === 3)) return "hsl";
  },
});
var ai = (e, o, t) => re(e, o, t, "hsl");
T.hsl = ai;
var { floor: ii } = Math,
  li = (...e) => {
    e = u(e, "hsv");
...
var { min: ci, max: mi } = Math,
  ...
  xn = fi;
m.prototype.hsv = function () {
  return xn(this._rgb);
};
var di = (...e) => new m(...e, "hsv");
E.hsv = di;
x.format.hsv = bn;
x.autodetect.push({
  p: 2,
  test: (...e) => {
    if (((e = u(e, "hsv")), b(e) === "array" && e.length === 3)) return "hsv";
  },
});
var pi = (e, o, t) => re(e, o, t, "hsv");
T.hsv = pi;
function Ae(e, o) {
  let t = e.length;
  (Array.isArray(e[0]) || (e = [e]),
    Array.isArray(o[0]) || (o = o.map((a) => [a])));
  let n = o[0].length,
    r = o[0].map((a, i) => o.map((l) => l[i])),
    s = e.map((a) =>
      r.map((i) =>
        Array.isArray(a)
          ? a.reduce((l, c, f) => l + c * (i[f] || 0), 0)
          : i.reduce((l, c) => l + c * a, 0),
      ),
    );
  return (t === 1 && (s = s[0]), n === 1 ? s.map((a) => a[0]) : s);
}
var gi = (...e) => {
  e = u(e, "lab");
  let [o, t, n, ...r] = e,
...
var hi = (...e) => {
  let [o, t, n, ...r] = u(e, "rgb"),
    s = et(o, t, n);
  return [...bi(s), ...(r.length > 0 && r[0] < 1 ? [r[0]] : [])];
};
function bi(e) {
  let o = [
...
var Be = hi;
m.prototype.oklab = function () {
  return Be(this._rgb);
};
var xi = (...e) => new m(...e, "oklab");
Object.assign(E, { oklab: xi });
x.format.oklab = Oe;
x.autodetect.push({
  p: 2,
  test: (...e) => {
    if (((e = u(e, "oklab")), b(e) === "array" && e.length === 3))
      return "oklab";
  },
});
var yi = (e, o, t) => {
...
T.oklab = yi;
var ki = (e, o, t) => re(e, o, t, "oklch");
T.oklch = ki;
var { pow: nt, sqrt: rt, PI: st, cos: yn, sin: kn, atan2: wi } = Math,
  wn = (e, o = "lrgb", t = null) => {
    let n = e.length;
    t || (t = Array.from(new Array(n)).map(() => 1));
    let r =
      n /
      t.reduce(function (g, d) {
        return g + d;
      });
    if (
      (t.forEach((g, d) => {
    ...
    for (let g = 0; g < a.length; g++)
      if (
        ((a[g] = (a[g] || 0) * t[0]),
        i.push(isNaN(a[g]) ? 0 : t[0]),
        o.charAt(g) === "h" && !isNaN(a[g]))
      ) {
        let d = (a[g] / 180) * st;
        ((l += yn(d) * t[0]), (c += kn(d) * t[0]));
      }
    let f = s.alpha() * t[0];
    e.forEach((g, d) => {
      let h = g.get(o);
      ...
      for (let j = 0; j < a.length; j++)
        if (!isNaN(h[j]))
          if (((i[j] += t[d + 1]), o.charAt(j) === "h")) {
            let I = (h[j] / 180) * st;
            ((l += yn(I) * t[d + 1]), (c += kn(I) * t[d + 1]));
          } else a[j] += h[j] * t[d + 1];
    });
    for (let g = 0; g < a.length; g++)
      if (o.charAt(g) === "h") {
        let d = (wi(c / i[g], l / i[g]) / st) * 180;
        for (; d < 0; ) d += 360;
        for (; d >= 360; ) d -= 360;
        a[g] = d;
      } else a[g] = a[g] / i[g];
    return ((f /= n), new m(a, o).alpha(f > 0.99999 ? 1 : f, !0));
  },
  Ei = (e, o) => {
    let t = e.length,
      n = [0, 0, 0, 0];
...
function Pe(e) {
  let o = "rgb",
    ...
    w = function (p) {
      if (
        ...
        p &&
          b(p) === "string" &&
          E.brewer &&
          E.brewer[p.toLowerCase()] &&
          (p = E.brewer[p.toLowerCase()]),
        b(p) === "array")
      ) {
        (p.length === 1 && (p = [p[0], p[0]]), (p = p.slice(0)));
        for (let v = 0; v < p.length; v++) p[v] = E(p[v]);
        a.length = 0;
        for (let v = 0; v < p.length; v++) a.push(v / (p.length - 1));
      }
      return (K(), (c = p));
    },
    D = function (p) {
    ...
    V = function (p, v) {
      let F, N;
      if ((v == null && (v = !1), isNaN(p) || p === null)) return t;
      (v
        ? (N = p)
        : l && l.length > 2
          ? (N = D(p) / (l.length - 2))
      ...
      if (I && j[z]) F = j[z];
        ...
        if (b(c) === "array")
          for (let C = 0; C < a.length; C++) {
            ...
            if (N > X && N < a[C + 1]) {
              ((N = (N - X) / (a[C + 1] - X)),
                (F = E.interpolate(c[C], c[C + 1], N, o)));
              break;
            }
          }
        else b(c) === "function" && (F = c(N));
        I && (j[z] = F);
      }
      return F;
    };
  ...
  return (
    (P.classes = function (p) {
      if (p != null) {
        if (b(p) === "array") ((l = p), (r = [p[0], p[p.length - 1]]));
        else {
          let v = E.analyze(r);
          p === 0 ? (l = [v.min, v.max]) : (l = E.limits(v, "e", p));
        }
        return P;
      }
      return l;
    ...
    (P.domain = function (p) {
      ...
      ((s = p.slice(0)), (g = p[0]), (d = p[p.length - 1]), (a = []));
      let v = c.length;
      if (p.length === v && g !== d)
        for (let F of Array.from(p)) a.push((F - g) / (d - g));
      else {
        for (let F = 0; F < v; F++) a.push(F / (v - 1));
        if (p.length > 2) {
          let F = p.map((z, C) => C / (p.length - 1)),
            N = p.map((z) => (z - g) / (d - g));
          N.every((z, C) => F[C] === z) ||
            (R = (z) => {
              if (z <= 0 || z >= 1) return z;
              let C = 0;
              for (; z >= N[C + 1]; ) C++;
              let X = (z - N[C]) / (N[C + 1] - N[C]);
              return F[C] + X * (F[C + 1] - F[C]);
            });
        }
      }
      return ((r = [g, d]), P);
    ...
    (P.mode = function (p) {
      return arguments.length ? ((o = p), K(), P) : o;
    }),
    (P.range = function (p, v) {
      return (w(p, v), P);
    }),
    (P.out = function (p) {
      return ((f = p), P);
    ...
    (P.spread = function (p) {
      return arguments.length ? ((n = p), P) : n;
    }),
    (P.correctLightness = function (p) {
      return (
        p == null && (p = !0),
        (h = p),
        K(),
    ...
    (P.padding = function (p) {
      return p != null ? (b(p) === "number" && (p = [p, p]), (i = p), P) : i;
    }),
    (P.colors = function (p, v) {
      arguments.length < 2 && (v = "hex");
      let F = [];
      if (arguments.length === 0) F = c.slice(0);
      else if (p === 1) F = [P(0.5)];
      else if (p > 1) {
        let N = r[0],
          z = r[1] - N;
        F = vi(0, p, !1).map((C) => P(N + (C / (p - 1)) * z));
      } else {
        e = [];
        let N = [];
        if (l && l.length > 2)
          for (
            let z = 1, C = l.length, X = 1 <= C;
            X ? z < C : z > C;
            X ? z++ : z--
          )
            N.push((l[z - 1] + l[z]) * 0.5);
        else N = r;
        F = N.map((z) => P(z));
      }
      return (E[v] && (F = F.map((N) => N[v]())), F);
    }),
    (P.cache = function (p) {
      return p != null ? ((I = p), P) : I;
    }),
    (P.gamma = function (p) {
      return p != null ? ((k = p), P) : k;
    }),
    (P.nodata = function (p) {
      return p != null ? ((t = E(p)), P) : t;
    }),
    P
  );
}
function vi(e, o, t) {
  let n = [],
    r = e < o,
    s = t ? (r ? o + 1 : o - 1) : o;
  for (let a = e; r ? a < s : a > s; r ? a++ : a--) n.push(a);
  return n;
}
var Ni = function (e) {
    let o = [1, 1];
    for (let t = 1; t < e; t++) {
      let n = [1];
      for (let r = 1; r <= o.length; r++) n[r] = (o[r] || 0) + o[r - 1];
      o = n;
    }
    return o;
  },
  Ci = function (e) {
    let o, t, n, r;
    if (((e = e.map((s) => new m(s))), e.length === 2))
      (([t, n] = e.map((s) => s.lab())),
        (o = function (s) {
          let a = [0, 1, 2].map((i) => t[i] + s * (n[i] - t[i]));
          return new m(a, "lab");
        }));
    else if (e.length === 3)
      (([t, n, r] = e.map((s) => s.lab())),
        (o = function (s) {
          let a = [0, 1, 2].map(
            (i) =>
              (1 - s) * (1 - s) * t[i] + 2 * (1 - s) * s * n[i] + s * s * r[i],
          );
          return new m(a, "lab");
        }));
    else if (e.length === 4) {
      let s;
      (([t, n, r, s] = e.map((a) => a.lab())),
        (o = function (a) {
          let i = [0, 1, 2].map(
            (l) =>
              (1 - a) * (1 - a) * (1 - a) * t[l] +
      ...
      ((s = e.map((l) => l.lab())),
        ...
        (o = function (l) {
          let c = 1 - l,
            f = [0, 1, 2].map((g) =>
              s.reduce((d, h, j) => d + a[j] * c ** (i - j) * l ** j * h[g], 0),
            );
          return new m(f, "lab");
        }));
    } else
  ...
  En = (e) => {
    let o = Ci(e);
    return ((o.scale = () => Pe(o)), o);
  };
var { round: jn } = Math;
m.prototype.rgb = function (e = !0) {
  return e === !1 ? this._rgb.slice(0, 3) : this._rgb.slice(0, 3).map(jn);
};
m.prototype.rgba = function (e = !0) {
  return this._rgb
    .slice(0, 4)
    .map((o, t) => (t < 3 ? (e === !1 ? o : jn(o)) : o));
};
var Fi = (...e) => new m(...e, "rgb");
Object.assign(E, { rgb: Fi });
x.format.rgb = (...e) => {
  let o = u(e, "rgba");
...
x.autodetect.push({
  ...
  test: (...e) => {
    if (
      ...
      b(e) === "array" &&
        (e.length === 3 ||
          (e.length === 4 && b(e[3]) == "number" && e[3] >= 0 && e[3] <= 1)))
    )
      return "rgb";
  },
});
var ie = (e, o, t) => {
    if (!ie[t]) throw new Error("unknown blend mode " + t);
    return ie[t](e, o);
  },
  we = (e) => (o, t) => {
    let n = E(t).rgb(),
  ...
  Pi = (e, o) => (e > o ? o : e),
  zi = (e, o) => (e > o ? e : o),
  _i = (e, o) => 255 * (1 - (1 - e / 255) * (1 - o / 255)),
  Ti = (e, o) =>
    o < 128 ? (2 * e * o) / 255 : 255 * (1 - 2 * (1 - e / 255) * (1 - o / 255)),
  Di = (e, o) => 255 * (1 - (1 - o / 255) / (e / 255)),
  $i = (e, o) =>
    e === 255
      ? 255
      : ((e = (255 * (o / 255)) / (1 - e / 255)), e > 255 ? 255 : e);
ie.normal = we(Ee(Ii));
ie.multiply = we(Ee(Ai));
ie.screen = we(Ee(_i));
ie.overlay = we(Ee(Ti));
ie.darken = we(Ee(Pi));
ie.lighten = we(Ee(zi));
...
ie.burn = we(Ee(Di));
var vn = ie;
var { pow: Li, sin: Si, cos: Mi } = Math;
function Nn(e = 300, o = -1.5, t = 1, n = 1, r = [0, 1]) {
  let s = 0,
    a;
  b(r) === "array" ? (a = r[1] - r[0]) : ((a = 0), (r = [r, r]));
  let i = function (l) {
    let c = te * ((e + 120) / 360 + o * l),
      f = Li(r[0] + a * l, n),
      d = ((s !== 0 ? t[0] + l * s : t) * f * (1 - f)) / 2,
      h = Mi(c),
      j = Si(c),
      I = f + d * (-0.14861 * h + 1.78277 * j),
      k = f + d * (-0.29227 * h - 0.90649 * j),
      w = f + d * (1.97294 * h);
    return E(Ie([I * 255, k * 255, w * 255, 1]));
  };
  return (
    (i.start = function (l) {
...
var Oi = "0123456789abcdef",
  { floor: Bi, random: Ri } = Math,
  Cn = (e = Ri) => {
    let o = "#";
    for (let t = 0; t < 6; t++) o += Oi.charAt(Bi(e() * 16));
    return new m(o, "hex");
  };
var { log: Fn, pow: Vi, floor: qi, abs: Hi } = Math;
function at(e, o = null) {
  let t = {
  ...
  return (
    ...
    (t.limits = (n, r) => it(t, n, r)),
    t
  );
}
function it(e, o = "equal", t = 7) {
  b(e) == "array" && (e = at(e));
  let { min: n, max: r } = e,
    s = e.values.sort((i, l) => i - l);
  if (t === 1) return [n, r];
  let a = [];
  if (
    (o.substr(0, 1) === "c" && (a.push(n), a.push(r)), o.substr(0, 1) === "e")
  ) {
    a.push(n);
    for (let i = 1; i < t; i++) a.push(n + (i / t) * (r - n));
    a.push(r);
  } else if (o.substr(0, 1) === "l") {
    if (n <= 0)
      throw new Error("Logarithmic scales are only possible for values > 0");
    let i = Math.LOG10E * Fn(n),
      l = Math.LOG10E * Fn(r);
    a.push(n);
    for (let c = 1; c < t; c++) a.push(Vi(10, i + (c / t) * (l - i)));
    a.push(r);
  } else if (o.substr(0, 1) === "q") {
    a.push(n);
    for (let i = 1; i < t; i++) {
      let l = ((s.length - 1) * i) / t,
        c = qi(l);
      if (c === l) a.push(s[c]);
      else {
        let f = l - c;
        a.push(s[c] * (1 - f) + s[c + 1] * f);
      }
    }
    a.push(r);
    ...
    let i,
      ...
      h = null;
    ((h = []), h.push(n));
    for (let k = 1; k < t; k++) h.push(n + (k / t) * (r - n));
    for (h.push(r); g; ) {
      for (let w = 0; w < t; w++) f[w] = 0;
      for (let w = 0; w < l; w++) {
        let D = s[w],
          $ = Number.MAX_VALUE,
          R;
      ...
      let k = new Array(t);
      for (let w = 0; w < t; w++) k[w] = null;
      for (let w = 0; w < l; w++)
        ((i = c[w]), k[i] === null ? (k[i] = s[w]) : (k[i] += s[w]));
      for (let w = 0; w < t; w++) k[w] *= 1 / f[w];
      g = !1;
      for (let w = 0; w < t; w++)
        if (k[w] !== h[w]) {
          g = !0;
    ...
    let j = {};
    for (let k = 0; k < t; k++) j[k] = [];
    for (let k = 0; k < l; k++) ((i = c[k]), j[i].push(s[k]));
    let I = [];
    for (let k = 0; k < t; k++)
      (I.push(j[k][0]), I.push(j[k][j[k].length - 1]));
    ((I = I.sort((k, w) => k - w)), a.push(I[0]));
    for (let k = 1; k < I.length; k += 2) {
      let w = I[k];
...
var An = 0.027,
  ...
  Tn = (e, o) => {
    ((e = new m(e)),
      (o = new m(o)),
      e.alpha() < 1 && (e = de(o, e, e.alpha(), "rgb")));
    let t = _n(...e.rgb()),
      n = _n(...o.rgb()),
      r = t >= ko ? t : t + Math.pow(ko - t, zn),
      s = n >= ko ? n : n + Math.pow(ko - n, zn),
      a = Math.pow(s, 0.56) - Math.pow(r, 0.57),
      i = Math.pow(s, 0.65) - Math.pow(r, 0.62),
      l = Math.abs(s - r) < Gi ? 0 : r < s ? a * Pn : i * Pn;
    return (Math.abs(l) < Wi ? 0 : l > 0 ? l - An : l + An) * 100;
  };
function _n(e, o, t) {
  return (
    0.2126729 * Math.pow(e / 255, 2.4) +
    0.7151522 * Math.pow(o / 255, 2.4) +
    0.072175 * Math.pow(t / 255, 2.4)
  );
}
var {
  sqrt: ge,
...
function Mn(e, o, t = 1, n = 1, r = 1) {
  ...
  ((e = new m(e)), (o = new m(o)));
  let [i, l, c] = Array.from(e.lab()),
    [f, g, d] = Array.from(o.lab()),
    h = (i + f) / 2,
    j = ge(O(l, 2) + O(c, 2)),
    I = ge(O(g, 2) + O(d, 2)),
    k = (j + I) / 2,
    w = 0.5 * (1 - ge(O(k, 7) / (O(k, 7) + O(25, 7)))),
    D = l * (1 + w),
    $ = g * (1 + w),
    R = ge(O(D, 2) + O(c, 2)),
    V = ge(O($, 2) + O(d, 2)),
    ...
    z =
      ...
      0.2 * wo(a(4 * N - 63)),
    C = F - v;
  ((C = $n(C) <= 180 ? C : F <= v ? C + 360 : C - 360),
    (C = 2 * ge(R * V) * Ln(a(C) / 2)));
  let X = f - i,
    he = V - R,
    Ue = 1 + (0.015 * O(h - 50, 2)) / ge(20 + O(h - 50, 2)),
    He = 1 + 0.045 * K,
    Je = 1 + 0.015 * K * z,
    Ps = 30 * Yi(-O((N - 275) / 25, 2)),
    zs = -(2 * ge(O(K, 7) / (O(K, 7) + O(25, 7)))) * Ln(2 * a(Ps)),
    _s = ge(
      O(X / (t * Ue), 2) +
        O(he / (n * He), 2) +
        O(C / (r * Je), 2) +
  ...
  return Qi(0, Xi(100, _s));
}
function On(e, o, t = "lab") {
  ((e = new m(e)), (o = new m(o)));
  let n = e.get(t),
    r = o.get(t),
    s = 0;
...
var Rn = {
  cool() {
    return Pe([E.hsl(180, 1, 0.9), E.hsl(250, 0.7, 0.4)]);
  },
  hot() {
    return Pe(["#000", "#f00", "#ff0", "#fff"], [0, 0.25, 0.75, 1]).mode("rgb");
  },
};
var lt = {
    OrRd: [
  ...
  qn = Object.keys(lt),
  Vn = new Map(qn.map((e) => [e.toLowerCase(), e])),
  Zi =
    typeof Proxy == "function"
      ? new Proxy(lt, {
          get(e, o) {
            let t = o.toLowerCase();
            if (Vn.has(t)) return e[Vn.get(t)];
          },
          getOwnPropertyNames() {
            return Object.getOwnPropertyNames(qn);
          },
        })
      : lt,
  Hn = Zi;
...
var Ji = (...e) => new m(...e, "cmyk");
Object.assign(E, { cmyk: Ji });
x.format.cmyk = Gn;
x.autodetect.push({
  p: 2,
  test: (...e) => {
    if (((e = u(e, "cmyk")), b(e) === "array" && e.length === 4)) return "cmyk";
  },
});
var el = (...e) => {
    let o = u(e, "hsla"),
    ...
    return (
      ...
      (o[1] = G(o[1] * 100) + "%"),
      (o[2] = G(o[2] * 100) + "%"),
      t === "hsla" || (o.length > 3 && o[3] < 1)
        ? ((o[3] = "/ " + (o.length > 3 ? o[3] : 1)), (t = "hsla"))
        : (o.length = 3),
      `${t.substr(0, 3)}(${o.join(" ")})`
    );
  },
...
var ol = (...e) => {
    ...
    return (
      ...
      (o[1] = G(o[1])),
      (o[2] = G(o[2])),
      t === "laba" || (o.length > 3 && o[3] < 1)
        ? (o[3] = "/ " + (o.length > 3 ? o[3] : 1))
        : (o.length = 3),
      `lab(${o.join(" ")})`
    );
  },
...
var tl = (...e) => {
    ...
    return (
      (o[0] = G(o[0]) + "%"),
      (o[1] = G(o[1])),
      (o[2] = isNaN(o[2]) ? "none" : G(o[2]) + "deg"),
      t === "lcha" || (o.length > 3 && o[3] < 1)
        ? (o[3] = "/ " + (o.length > 3 ? o[3] : 1))
        : (o.length = 3),
      `lch(${o.join(" ")})`
    );
...
var { round: ct } = Math,
  al = (...e) => {
    let o = u(e, "rgba"),
      t = U(e) || "rgb";
    if (t.substr(0, 3) === "hsl") return Qn(yo(o), t);
    if (t.substr(0, 3) === "lab") {
      let n = ke();
      ne("d50");
      let r = Yn($e(o), t);
    ...
    return t.substr(0, 5) === "oklab"
      ...
      : t.substr(0, 5) === "oklch"
        ...
        : ((o[0] = ct(o[0])),
          (o[1] = ct(o[1])),
          (o[2] = ct(o[2])),
          (t === "rgba" || (o.length > 3 && o[3] < 1)) &&
            ((o[3] = "/ " + (o.length > 3 ? o[3] : 1)), (t = "rgba")),
          `${t.substr(0, 3)}(${o.slice(0, t === "rgb" ? 3 : 4).join(" ")})`);
  },
  Jn = al;
var il = (...e) => {
    e = u(e, "lch");
  ...
  jo = il;
var ue = /((?:-?\d+)|(?:-?\d+(?:\.\d+)?)%|none)/.source,
  le = /((?:-?(?:\d+(?:\.\d*)?|\.\d+)%?)|none)/.source,
  vo = /((?:-?(?:\d+(?:\.\d*)?|\.\d+)%)|none)/.source,
  se = /\s*/.source,
  Ve = /\s+/.source,
  mt = /\s*,\s*/.source,
  No = /((?:-?(?:\d+(?:\.\d*)?|\.\d+)(?:deg)?)|none)/.source,
  qe = /\s*(?:\/\s*((?:[01]|[01]?\.\d+)|\d+(?:\.\d+)?%))?/.source,
  er = new RegExp("^rgba?\\(" + se + [ue, ue, ue].join(Ve) + qe + "\\)$"),
  or = new RegExp("^rgb\\(" + se + [ue, ue, ue].join(mt) + se + "\\)$"),
  tr = new RegExp("^rgba\\(" + se + [ue, ue, ue, le].join(mt) + se + "\\)$"),
  nr = new RegExp("^hsla?\\(" + se + [No, vo, vo].join(Ve) + qe + "\\)$"),
  rr = new RegExp("^hsl?\\(" + se + [No, vo, vo].join(mt) + se + "\\)$"),
  sr =
    /^hsla\(\s*(-?\d+(?:\.\d+)?),\s*(-?\d+(?:\.\d+)?)%\s*,\s*(-?\d+(?:\.\d+)?)%\s*,\s*([01]|[01]?\.\d+)\)$/,
  ar = new RegExp("^lab\\(" + se + [le, le, le].join(Ve) + qe + "\\)$"),
  ir = new RegExp("^lch\\(" + se + [le, le, No].join(Ve) + qe + "\\)$"),
  lr = new RegExp("^oklab\\(" + se + [le, le, le].join(Ve) + qe + "\\)$"),
  cr = new RegExp("^oklch\\(" + se + [le, le, No].join(Ve) + qe + "\\)$"),
  { round: mr } = Math,
  Re = (e) => e.map((o, t) => (t <= 2 ? oe(mr(o), 0, 255) : o)),
  B = (e, o = 0, t = 100, n = !1) => (
    typeof e == "string" &&
      e.endsWith("%") &&
      ((e = parseFloat(e.substring(0, e.length - 1)) / 100),
      n ? (e = o + (e + 1) * 0.5 * (t - o)) : (e = o + e * (t - o))),
    +e
  ),
  Q = (e, o) => (e === "none" ? o : e),
  fr = (e) => {
    ...
    if (x.format.named)
      try {
        return x.format.named(e);
      } catch {}
    if ((o = e.match(er)) || (o = e.match(or))) {
      let t = o.slice(1, 4);
      for (let r = 0; r < 3; r++) t[r] = +B(Q(t[r], 0), 0, 255);
      t = Re(t);
      let n = o[4] !== void 0 ? +B(o[4], 0, 1) : 1;
      return ((t[3] = n), t);
    }
    if ((o = e.match(tr))) {
      let t = o.slice(1, 5);
      for (let n = 0; n < 4; n++) t[n] = +B(t[n], 0, 255);
      return t;
    }
    if ((o = e.match(nr)) || (o = e.match(rr))) {
      let t = o.slice(1, 4);
      ((t[0] = +Q(t[0].replace("deg", ""), 0)),
        (t[1] = +B(Q(t[1], 0), 0, 100) * 0.01),
        (t[2] = +B(Q(t[2], 0), 0, 100) * 0.01));
      let n = Re(Ye(t)),
        r = o[4] !== void 0 ? +B(o[4], 0, 1) : 1;
      return ((n[3] = r), n);
    }
    if ((o = e.match(sr))) {
      let t = o.slice(1, 4);
      ((t[1] *= 0.01), (t[2] *= 0.01));
      let n = Ye(t);
      for (let r = 0; r < 3; r++) n[r] = mr(n[r]);
      return ((n[3] = +o[4]), n);
    }
    if ((o = e.match(ar))) {
      let t = o.slice(1, 4);
      ((t[0] = B(Q(t[0], 0), 0, 100)),
        (t[1] = B(Q(t[1], 0), -125, 125, !0)),
        (t[2] = B(Q(t[2], 0), -125, 125, !0)));
      let n = ke();
      ne("d50");
      let r = Re(De(t));
      ne(n);
      let s = o[4] !== void 0 ? +B(o[4], 0, 1) : 1;
      return ((r[3] = s), r);
    }
    if ((o = e.match(ir))) {
      let t = o.slice(1, 4);
      ((t[0] = B(t[0], 0, 100)),
        (t[1] = B(Q(t[1], 0), 0, 150, !1)),
        (t[2] = +Q(t[2].replace("deg", ""), 0)));
      let n = ke();
      ne("d50");
      let r = Re(Le(t));
      ne(n);
    ...
    if ((o = e.match(lr))) {
      let t = o.slice(1, 4);
      ((t[0] = B(Q(t[0], 0), 0, 1)),
        (t[1] = B(Q(t[1], 0), -0.4, 0.4, !0)),
        (t[2] = B(Q(t[2], 0), -0.4, 0.4, !0)));
      let n = Re(Oe(t)),
        r = o[4] !== void 0 ? +B(o[4], 0, 1) : 1;
      return ((n[3] = r), n);
    }
...
var ll = (...e) => new m(...e, "css");
E.css = ll;
x.format.css = ft;
x.autodetect.push({
  p: 5,
  test: (e, ...o) => {
    if (!o.length && b(e) === "string" && ft.test(e)) return "css";
  },
});
x.format.gl = (...e) => {
  let o = u(e, "rgba");
...
m.prototype.hex = function (e) {
  return ho(this._rgb, e);
};
var ml = (...e) => new m(...e, "hex");
E.hex = ml;
x.format.hex = go;
x.autodetect.push({
  p: 4,
          ...
          (n =
            o < 6
              ...
              : -155.25485562709179 -
                ...
                104.49216199393888 * Co(n)),
          (r =
            o < 20
              ? 0
              : -254.76935184120902 +
                0.8274096064007395 * (r = o - 10) +
                115.67994401066147 * Co(r)))
        : ((t =
            351.97690566805693 +
            0.114206453784165 * (t = o - 55) -
            40.25366309332127 * Co(t)),
          (n =
            325.4494125711974 +
            0.07943456536662342 * (n = o - 50) -
            28.0852963507957 * Co(n)),
          (r = 255)),
      [t, n, r, 1]
    );
  },
...
m.prototype.temp =
  m.prototype.kelvin =
  m.prototype.temperature =
    function () {
      return dr(this._rgb);
    };
var dt = (...e) => new m(...e, "temp");
Object.assign(E, { temp: dt, kelvin: dt, temperature: dt });
x.format.temp = x.format.kelvin = x.format.temperature = Fo;
m.prototype.oklch = function () {
  return Eo(this._rgb);
};
var gl = (...e) => new m(...e, "oklch");
Object.assign(E, { oklch: gl });
x.format.oklch = jo;
x.autodetect.push({
  p: 2,
  test: (...e) => {
    if (((e = u(e, "oklch")), b(e) === "array" && e.length === 3))
      return "oklch";
  },
});
Object.assign(E, {
...
var J = E;
var gr = ["fill", "stroke", "stop-color"];
function ur(e, o = {}) {
  let { respectNoRecolor: t = !0 } = o,
    n = t ? yl(e) : e,
    r = new Set();
  for (let s of gr) {
    for (let a of n.matchAll(ul(s))) J.valid(a[1]) && r.add(a[1]);
    for (let a of n.matchAll(bl(s))) {
      let i = a[1].trim();
      J.valid(i) && r.add(i);
    }
  }
...
function hr(e, o) {
  ...
  let t = br(e),
    n = e;
  for (let r of gr)
    ((n = n.replace(hl(r), (s, a, i, l, c) =>
      pr(c, t) ? s : o.has(i) ? a + o.get(i) + l : s,
    )),
      (n = n.replace(xl(r), (s, a, i, l) => {
        if (pr(l, t)) return s;
        let c = i.trim();
        return o.has(c) ? a + o.get(c) : s;
      })));
  return n;
}
function ul(e) {
  return new RegExp(`\\b${e}="([^"]*)"`, "gi");
}
function hl(e) {
  return new RegExp(`(\\b${e}=")([^"]*)(")`, "gi");
}
function bl(e) {
  return new RegExp(`(?<![\\w-])${e}\\s*:\\s*([^;}"]+)`, "gi");
}
function xl(e) {
  return new RegExp(`((?<![\\w-])${e}\\s*:\\s*)([^;}"]+)`, "gi");
}
function yl(e) {
  ...
  for (let n = o.length - 1; n >= 0; n--)
    t = t.slice(0, o[n].start) + t.slice(o[n].end);
  return t;
}
function br(e) {
  let o = [],
    t = 'data-mit-no-recolor="true"',
    n = 0;
  for (;;) {
    let r = e.indexOf(t, n);
    if (r === -1) break;
    let s = e.lastIndexOf("<", r);
    if (s === -1) {
      n = r + t.length;
      continue;
    }
    ...
    if (e[a - 1] === "/") (o.push({ start: s, end: a + 1 }), (n = a + 1));
    else {
      let l = `</${e.slice(s + 1, e.indexOf(" ", s + 1))}>`,
        c = e.indexOf(l, a),
        f = c === -1 ? a + 1 : c + l.length;
      (o.push({ start: s, end: f }), (n = f));
    }
  }
  return o;
}
function pr(e, o) {
  return o.some((t) => e >= t.start && e < t.end);
}
var Io = () => ({
  iconDefinitions: {},
  folderNames: {},
...
var pt = {
  ...
  yr = (e) => {
    let o = Object.values(pt);
    if (!gt(e)) throw new Error(`The given color "${e}" is not valid!`);
    return (
      (e = J(e).hex()),
      o
        .map((n) => ({ distance: J.deltaE(n, e), color: n }))
        .sort((n, r) => n.distance - r.distance)[0].color
    );
  };
var kr = (e) => ur(e),
  kl = (e) =>
    Array.from(e).sort((t, n) => {
      let r = J(t).get("hsl.l"),
        s = J(n).get("hsl.l");
      return r < s ? -1 : r > s ? 1 : 0;
    }),
  wl = (e, o) => e.set("hsl.l", e.get("hsl.l") + o),
  gt = (e) => (e === void 0 ? !1 : J.valid(e)),
  wr = (e, o) => {
    if (!gt(e)) {
      let i = xr(e);
      if (i === void 0) throw new Error(`Invalid color: ${e}`);
      e = i;
    }
    let t = kl(o),
      n = J(e),
    ...
    for (let i = 1; i < t.length; i++) {
      let c = J(t[i]).set("hsl.h", r);
      (t.length === 2 && (c = c.set("hsl.s", n.get("hsl.s"))),
        c.luminance() < a.luminance() &&
          ((c = c.set("hsl.l", a.get("hsl.l"))), (c = wl(c, 0.1))));
      let f = yr(c.hex());
      ((a = J(f)), s.set(t[i], f));
    }
    return s;
...
var El = async (e, o) => {
    try {
      return await (0, ut.readFile)(e, "utf8");
    } catch {
      let t = e.replace(o, "");
      return await (0, ut.readFile)(t, "utf8");
    }
  },
  Er = async (e, o, t = "") => {
    let n = await El(e, t),
...
var ht = async (e, o) => {
  ...
  let t = _({}, e),
    n = ce(o),
    r = async (l) => {
      for (let c of l != null ? l : [])
        if (
          c.activeForPacks === void 0 ||
          c.activeForPacks.includes(o.activeIconPack)
        ) {
          let f = await jl(c, e, n);
          t = _(t, f);
        }
    };
  return (
    await r((s = o.folders) == null ? void 0 : s.customClones),
    await r((a = o.files) == null ? void 0 : a.customClones),
    await r((i = o.languages) == null ? void 0 : i.customClones),
    t
  );
};
var Ao = (e) => {
    var o, t, n, r, s, a, i, l, c;
    return (
      ((n =
        (t = (o = e.folders) == null ? void 0 : o.customClones) == null
          ? void 0
          : t.length) != null
        ? n
        : 0) > 0 ||
      ((a =
        ...
        : 0) > 0 ||
      ((c =
        (l = (i = e.languages) == null ? void 0 : i.customClones) == null
          ? void 0
          : l.length) != null
        ? c
        : 0) > 0
  ...
  jl = async (e, o, t) => {
    ...
    for (let s of n)
      try {
        let a = await Er(s.base.path, s.color, t);
        try {
          await ae(s.path, a);
        } catch (i) {
          return (y.error(i), o);
        }
        ((r.iconDefinitions[s.name] = { iconPath: s.inConfigPath }),
          ao(e)
            ? (vr(e.folderNames, s.variant, r, s.name, !1),
              vr(e.rootFolderNames, s.variant, r, s.name, !0))
            : on(e)
              ? Nl(e, s, r)
              : Cl(e, s, r));
      } catch (a) {
  ...
  vl = (e, o, t) =>
    e === 0
      ...
      : e === 1
        ? t
          ? o.rootFolderNamesExpanded
          : o.folderNamesExpanded
        : e === 2
          ? t
            ? o.light.rootFolderNames
            : o.light.folderNames
          : t
            ? o.light.rootFolderNamesExpanded
            : o.light.folderNamesExpanded,
  vr = (e, o, t, n, r) => {
    let s = vl(o, t, r);
    e == null ||
      e.forEach((a) => {
  ...
  Nl = (e, o, t) => {
    ...
    (n = e.ids) == null ||
      n.forEach((r) => {
        let s = o.variant === 0 ? t.languageIds : t.light.languageIds;
        s[r] = o.name;
      });
  };
function Cl(e, o, t) {
  ...
  ((n = e.fileNames) == null ||
    n.forEach((s) => {
      let a = o.variant === 0 ? t.fileNames : t.light.fileNames;
      a[s] = o.name;
    }),
    (r = e.fileExtensions) == null ||
      r.forEach((s) => {
        let a = o.variant === 0 ? t.fileExtensions : t.light.fileExtensions;
        a[s] = o.name;
      }));
}
var bt = ((f) => (
...
var Fl = (e) =>
    Object.entries(e).flatMap(([o, t]) => {
      switch (t) {
        ...
        default:
          let n = t;
          throw new Error(`Unhandled pattern: ${n}`);
      }
    }),
  Nr = (e) =>
    e.map(({ patterns: o, fileNames: t = [], ...n }) => ({
      ...n,
      fileNames: o ? [...Fl(o), ...t] : t,
    }));
var Cr = {
  ...
  icons: Nr([
    ...
    { name: "toml", fileExtensions: ["toml"], light: !0 },
    ...
    { name: "typedoc", fileNames: ["typedoc.js", "typedoc.json"] },
    { name: "markdoc", fileExtensions: ["mdoc", "markdoc", "markdoc.md"] },
    { name: "markdoc-config", patterns: { "markdoc.config": "ecmascript" } },
    ...
    { name: "ruff", fileNames: ["ruff.toml", ".ruff.toml"] },
    ...
    { name: "certificate", fileExtensions: ["cer", "cert", "crt"] },
    {
      name: "license",
      fileNames: [
        "copying",
    ...
    { name: "unlicense", fileNames: ["unlicense", "unlicense.txt"] },
    {
      name: "key",
      fileExtensions: [
        "pub",
    ...
    { name: "liara", fileNames: ["liara.json", ".liaraignore"] },
    { name: "verdaccio", fileNames: ["verdaccio.yml"] },
    {
      name: "payload",
      fileNames: [
        "payload.config.js",
    ...
    { name: "opentofu", fileExtensions: ["tofu"], light: !0 },
    {
      name: "laravel",
    ...
    { name: "kl", fileExtensions: ["kl"], fileNames: [".kl"] },
    {
      ...
      patterns: { postcss: "cosmiconfig" },
    },
    { name: "posthtml", patterns: { posthtml: "cosmiconfig" } },
    {
      name: "todo",
      fileExtensions: ["todo"],
    ...
    },
    {
      ...
      patterns: {
        "rspack.config": "ecmascript",
        "rsbuild.config": "ecmascript",
        "rslib.config": "ecmascript",
        "rstest.config": "ecmascript",
        "rspress.config": "ecmascript",
        "rslint.config": "ecmascript",
      },
    },
    { name: "lynx", patterns: { "lynx.config": "ecmascript" } },
    ...
    { name: "turborepo", light: !0, fileNames: ["turbo.json", "turbo.jsonc"] },
    {
      name: "babel",
      fileNames: ["babel-transform.js"],
      patterns: { babel: "cosmiconfig", "babel-plugin-macros": "cosmiconfig" },
    },
    {
      name: "blitz",
      fileNames: [
    ...
    { name: "adobe-illustrator", fileExtensions: ["ai", "ait"], light: !0 },
    {
    ...
    },
    {
      ...
      patterns: { "svelte.config": "ecmascript" },
    },
    {
      name: "svelte_js",
    ...
    { name: "husky", patterns: { husky: "cosmiconfig" } },
    ...
    },
    {
      ...
      patterns: { commitlint: "cosmiconfig" },
    },
    ...
    { name: "duc", fileNames: ["duc.fbs"], fileExtensions: ["duc"] },
    {
      name: "snowpack",
      fileNames: [
        "snowpack.config.js",
    ...
    { name: "vite", patterns: { "vite.config": "ecmascript" } },
    {
      name: "vitest",
      patterns: {
        "vitest.workspace": "ecmascript",
        "vitest.config": "ecmascript",
        "vitest.unit.config": "ecmascript",
        "vitest.e2e.config": "ecmascript",
      },
    },
    { name: "velite", patterns: { "velite.config": "ecmascript" } },
    { name: "rolldown", patterns: { "rolldown.config": "ecmascript" } },
    ...
    { name: "gemini", fileExtensions: ["gmi", "gemini"] },
    {
      ...
      patterns: {
        "sentry.client.config": "ecmascript",
        "sentry.server.config": "ecmascript",
        "sentry.edge.config": "ecmascript",
      },
    },
    { name: "contentlayer", patterns: { "contentlayer.config": "ecmascript" } },
    ...
    { name: "maven", fileNames: ["maven.config", "jvm.config", "pom.xml"] },
    ...
    { name: "svgr", patterns: { svgr: "cosmiconfig" } },
    { name: "rome", fileNames: ["rome.json"] },
    {
      name: "cypress",
      fileNames: ["cypress.json", "cypress.env.json"],
      patterns: { "cypress.config": "ecmascript" },
    },
    ...
    { name: "craco", patterns: { craco: "cosmiconfig" } },
    { name: "gamemaker", fileExtensions: ["gml", "yy", "yyp", "yyz"] },
    { name: "tldraw", fileExtensions: ["tldr"], light: !0 },
    {
      name: "mercurial",
      fileNames: [
        ".hg",
    ...
    { name: "qwik", fileExtensions: ["tsx"], enabledFor: ["qwik"] },
    { name: "mermaid", fileExtensions: ["mmd", "mermaid"] },
    { name: "syncpack", patterns: { syncpack: "cosmiconfig" } },
    { name: "mojo", fileExtensions: ["mojo", "\u{1F525}"] },
    {
      name: "werf",
      fileNames: [
        "werf.yaml",
    ...
    { name: "luau", fileExtensions: ["luau"], fileNames: [".luaurc"] },
    {
      name: "rojo",
    ...
    { name: "rbxmk", fileExtensions: ["rbxmk.lua", "rbxmk.luau"] },
    { name: "panda", patterns: { "panda.config": "ecmascript" } },
    {
      name: "biome",
    ...
    },
    {
      ...
      patterns: {
        esbuild: "ecmascript",
        "esbuild.config": "ecmascript",
        "esbuild.dev": "ecmascript",
        "esbuild.stage": "ecmascript",
        "esbuild.prod": "ecmascript",
        "esbuild.test": "ecmascript",
      },
    },
    ...
    { name: "abap", fileExtensions: ["abap", "acds", "asddls"] },
    {
      name: "drizzle",
      fileNames: [
        "drizzle.config.ts",
    ...
    { name: "puppeteer", patterns: { puppeteer: "cosmiconfig" } },
    ...
    { name: "screwdriver", fileNames: ["screwdriver.yaml", "screwdriver.yml"] },
    { name: "snapcraft", fileNames: ["snapcraft.yaml", "snapcraft.yml"] },
    {
      name: "container",
    ...
    { name: "verified", fileExtensions: ["sigstore.json"] },
    { name: "bruno", fileExtensions: ["bru"] },
    { name: "cairo", fileExtensions: ["cairo"] },
    { name: "grafana-alloy", fileExtensions: ["alloy"] },
    { name: "clangd", fileNames: [".clangd"] },
    { name: "freemarker", fileExtensions: ["ftl"] },
    {
      name: "markdownlint",
      fileNames: [
        ".markdownlint.json",
    ...
    { name: "tsil", fileExtensions: ["\u0446"] },
    { name: "trigger", patterns: { "trigger.config": "ecmascript" } },
    ...
    { name: "hurl", fileExtensions: ["hurl"] },
    { name: "cds", fileExtensions: ["cds"] },
    { name: "slint", fileExtensions: ["slint", "60"] },
    { name: "jsr", fileNames: ["jsr.json", "jsr.jsonc"], light: !0 },
    {
      name: "coderabbit-ai",
      fileNames: [".coderabbit.yml", ".coderabbit.yaml"],
    },
    { name: "gemini-ai", fileNames: [".aiexclude", "GEMINI.md"] },
    {
      name: "taze",
      patterns: { "taze.config": "ecmascript" },
      fileNames: [".tazerc", ".tazerc.json"],
    },
    { name: "wxt", patterns: { "wxt.config": "ecmascript" } },
    { name: "verse", light: !0, fileExtensions: ["verse"] },
    { name: "sway", fileExtensions: ["sw"] },
    {
      name: "lefthook",
      fileNames: [
        ".lefthook-local.json",
    ...
    { name: "bench-jsx", fileExtensions: ["bench.jsx", "bench.tsx"] },
    {
      name: "bench-js",
    ...
    {
      name: "histoire",
      patterns: { "histoire.config": "ecmascript", ".histoire": "ecmascript" },
    },
    { name: "installation", fileNames: ["install", "installation"] },
    { name: "github-sponsors", fileNames: [".github/FUNDING.yml"] },
    { name: "minecraft-fabric", fileNames: ["fabric.mod.json"] },
    { name: "umi", patterns: { ".umirc": "ecmascript" } },
    { name: "pm2-ecosystem", patterns: { "ecosystem.config": "ecmascript" } },
    { name: "hosts", fileNames: ["hosts"], light: !0 },
    { name: "citation", fileNames: ["citation.cff"] },
    { name: "xmake", fileNames: ["xmake.lua", "xmake"] },
    {
      name: "subtitles",
      fileExtensions: [
        "srt",
    ...
    { name: "hadolint", patterns: { ".hadolint": "yaml", hadolint: "yaml" } },
    { name: "coloredpetrinets", fileExtensions: ["cpn", "pnml"] },
    { name: "pytorch", fileExtensions: ["pt", "pth", "pwf"] },
    ...
    { name: "claude", fileNames: ["CLAUDE.md", "CLAUDE.local.md"] },
    {
      name: "cursor",
      fileNames: [
        ".cursorignore",
    ...
    { name: "bashly", patterns: { "src/bashly": "yaml" } },
    {
      name: "bashly-settings",
      clone: { base: "bashly", color: "gray-300", lightColor: "gray-800" },
      patterns: { "bashly-settings": "yaml" },
      light: !0,
    },
    {
      name: "bashly-settings",
    ...
    {
      name: "bashly-strings",
      clone: { base: "bashly-hook", color: "gray-300", lightColor: "gray-800" },
      patterns: { "src/bashly-strings": "yaml" },
      light: !0,
    },
    {
      name: "google",
    ...
    { name: "toc", fileExtensions: ["toc"] },
    { name: "shellcheck", patterns: { shellcheckrc: "dotfile" }, light: !0 },
    { name: "cue", fileExtensions: ["cue"] },
    { name: "lean", fileExtensions: ["lean"] },
    { name: "salt", fileExtensions: ["sls"] },
    { name: "warp", fileNames: ["warp.md"], light: !0 },
    ...
    { name: "expo", fileNames: ["eas.json", ".easignore"], light: !0 },
    { name: "mrpack", fileExtensions: ["mrpack"] },
  ]),
};
var Ze = [
  {
    ...
    icons: [
      ...
      { name: "folder-directive", folderNames: ["directive", "directives"] },
      {
        name: "folder-jinja",
      ...
      { name: "folder-gh-workflows", folderNames: ["github/workflows"] },
      {
        ...
        clone: { base: "folder-gh-workflows", color: "light-green-700" },
      },
      {
        name: "folder-git",
      ...
      },
      {
        ...
        folderNames: ["effects"],
        enabledFor: ["angular_ngrx"],
        clone: { base: "folder-ngrx-store", color: "cyan-500" },
      },
      {
        name: "folder-ngrx-state",
        folderNames: ["states", "state"],
        enabledFor: ["angular_ngrx"],
        clone: { base: "folder-ngrx-store", color: "lime-800" },
      },
      {
        name: "folder-ngrx-reducer",
        folderNames: ["reducers", "reducer"],
        enabledFor: ["angular_ngrx"],
        clone: { base: "folder-ngrx-store", color: "red-400" },
      },
      {
        name: "folder-ngrx-actions",
        folderNames: ["actions"],
        enabledFor: ["angular_ngrx"],
        clone: { base: "folder-ngrx-store", color: "purple-400" },
      },
      {
        name: "folder-ngrx-entities",
        folderNames: ["entities"],
        enabledFor: ["angular_ngrx"],
        clone: { base: "folder-ngrx-store", color: "yellow-700" },
      },
      {
        name: "folder-ngrx-selectors",
        folderNames: ["selectors"],
        enabledFor: ["angular_ngrx"],
        clone: { base: "folder-ngrx-store", color: "deep-orange-A200" },
      },
      {
      ...
      },
      {
        ...
        folderNames: ["actions"],
        enabledFor: ["react_redux"],
        clone: { base: "folder-redux-reducer", color: "purple-400" },
      },
      {
        name: "folder-redux-toolkit",
        folderNames: ["redux", "redux-toolkit"],
        enabledFor: ["react_redux"],
        clone: { base: "folder-redux-reducer", color: "purple-300" },
      },
      {
        name: "folder-redux-selector",
        folderNames: ["selectors", "selector"],
        enabledFor: ["react_redux"],
        clone: { base: "folder-redux-reducer", color: "deep-orange-A200" },
      },
      {
        name: "folder-redux-store",
        folderNames: ["store", "stores"],
        enabledFor: ["react_redux"],
        clone: { base: "folder-redux-reducer", color: "light-green-500" },
      },
      {
        ...
        enabledFor: ["react", "react_redux"],
      },
      { name: "folder-astro", folderNames: ["astro"] },
      {
      ...
      { name: "folder-temp", folderNames: ["temp", "tmp", "cached", "cache"] },
      ...
      { name: "folder-mojo", folderNames: ["mojo"] },
      ...
      { name: "folder-ui", folderNames: ["presentation", "gui", "ui", "ux"] },
      ...
      { name: "folder-hook", folderNames: ["hook", "hooks"] },
      { name: "folder-trigger", folderNames: ["trigger", "triggers"] },
      ...
      { name: "folder-nuxt", folderNames: ["nuxt"] },
      {
        name: "folder-vue-directives",
        folderNames: ["directives"],
        enabledFor: ["vue_vuex", "vue"],
      },
      {
        name: "folder-vue",
      ...
      { name: "folder-queue", folderNames: ["queue", "queues", "bull", "mq"] },
      { name: "folder-vercel", folderNames: ["vercel", "now"] },
      { name: "folder-cypress", folderNames: ["cypress"] },
      { name: "folder-decorators", folderNames: ["decorator", "decorators"] },
      { name: "folder-java", folderNames: ["java"] },
      { name: "folder-resolver", folderNames: ["resolver", "resolvers"] },
      { name: "folder-angular", folderNames: ["angular"] },
      { name: "folder-unity", folderNames: ["unity"] },
      { name: "folder-pdf", folderNames: ["pdf", "pdfs"] },
      {
        name: "folder-proto",
        folderNames: ["protobuf", "protobufs", "proto", "protos"],
      },
      { name: "folder-plastic", folderNames: ["plastic"] },
      { name: "folder-gamemaker", folderNames: ["gamemaker", "gamemaker2"] },
      { name: "folder-mercurial", folderNames: ["hg", "hghooks", "hgext"] },
      { name: "folder-godot", folderNames: ["godot", "godot-cpp"] },
      {
        name: "folder-lottie",
        folderNames: ["lottie", "lotties", "lottiefiles"],
      },
      { name: "folder-taskfile", folderNames: ["taskfile", "taskfiles"] },
      { name: "folder-drizzle", folderNames: ["drizzle"] },
      { name: "folder-cloudflare", folderNames: ["cloudflare"] },
      {
        name: "folder-seeders",
      ...
      { name: "folder-snapcraft", folderNames: ["snap", "snapcraft"] },
      {
        ...
        clone: { base: "folder-src", color: "light-blue-700" },
      },
      ...
      { name: "folder-src-tauri", folderNames: ["src-tauri"] },
      { name: "folder-favicon", folderNames: ["favicon", "favicons"] },
      {
      ...
      { name: "folder-powershell", folderNames: ["powershell", "ps", "ps1"] },
      {
        name: "folder-repository",
        folderNames: ["repository", "repositories", "repo", "repos"],
      },
      { name: "folder-luau", folderNames: ["luau"] },
      ...
      { name: "folder-atom", folderNames: ["atoms", "atom"] },
      { name: "folder-molecule", folderNames: ["molecules", "molecule"] },
      { name: "folder-organism", folderNames: ["organisms", "organism"] },
      { name: "folder-claude", folderNames: ["claude"] },
      { name: "folder-cursor", folderNames: ["cursor"], light: !0 },
      {
        name: "folder-gemini-ai",
        folderNames: ["gemini", "gemini-ai", "geminiai"],
      },
      { name: "folder-opencode", folderNames: ["opencode"] },
      { name: "folder-input", folderNames: ["input", "inputs", "io", "in"] },
      { name: "folder-salt", folderNames: ["salt", "saltstack"] },
      {
        name: "folder-simulations",
        folderNames: ["simulations", "simulation", "sim", "sims"],
      },
      { name: "folder-metro", folderNames: ["metro"] },
      { name: "folder-filter", folderNames: ["filter", "filters"] },
      { name: "folder-toc", folderNames: ["toc", "table-of-contents"] },
      { name: "folder-cue", folderNames: ["cue", "cues"] },
      { name: "folder-license", folderNames: ["license", "licenses"] },
      { name: "folder-form", folderNames: ["form", "forms"] },
      {
        name: "folder-deprecated",
        folderNames: ["deprecated"],
        clone: { base: "folder-archive", color: "gray-700" },
      },
      {
        name: "folder-scrap",
        folderNames: ["scrap"],
        clone: { base: "folder-trash", color: "gray-700" },
      },
      { name: "folder-postman", folderNames: ["postman"] },
      { name: "folder-skills", folderNames: ["skill", "skills"] },
      {
        name: "folder-instructions",
        folderNames: ["instruction", "instructions"],
        clone: { base: "folder-meta", color: "cyan-A700" },
      },
      ...
      { name: "folder-go", folderNames: ["go", "golang"] },
      {
        name: "folder-eas",
        folderNames: ["eas"],
        clone: { base: "folder-expo", color: "gray-800" },
      },
...
var Fr = [
  ...
  { name: "github-actions-workflow", ids: ["github-actions-workflow"] },
  {
    name: "yaml",
  ...
  { name: "huff", ids: ["huff"] },
  { name: "cds", ids: ["cds", "capnb", "cds-markdown-injection"] },
  {
    name: "concourse",
    ids: ["concourse-pipeline-yaml", "concourse-task-yaml"],
  },
  { name: "systemd", light: !0, ids: ["systemd-conf", "systemd-unit-file"] },
  ...
  { name: "beancount", ids: ["beancount"] },
  {
    name: "ahk2",
    ids: ["ahk2"],
    clone: { base: "autohotkey", color: "lime-700" },
  },
...
var Ir = (e, o, t) => {
    var i;
    let n = Pl(e, o.activeIconPack),
      r = Al((i = o.languages) == null ? void 0 : i.associations),
      s = [...e, ...r],
      a = [...n, ...r];
    return (
      s.forEach((l) => {
      ...
      a.forEach((l) => {
        l.disabled ||
          ((t = _(t, yt(l.name, l.ids))),
          (t.light = l.light ? _(t.light, yt(l.name + M, l.ids)) : t.light),
          (t.highContrast = l.highContrast
            ? _(t.highContrast, yt(l.name + Z, l.ids))
            : t.highContrast));
      }),
      t
    );
  ...
  Il = (e, o, t, n) => {
    ...
    return (
      xt(e, o, t.name, r),
      t.light && xt(e, o, t.name + M, r),
      t.highContrast && xt(e, o, t.name + Z, r),
      e
    );
  },
  xt = (e, o, t, n) => {
    let r = ce(o);
    e.iconDefinitions &&
      (e.iconDefinitions[t] = { iconPath: `${H}${t}${r}${n}` });
  },
  yt = (e, o) => {
    let t = { languageIds: {} };
    return (
  ...
  Al = (e) =>
    e
      ? Object.keys(e).map((t) => ({
          name: e[t].toLowerCase(),
          ids: [t.toLowerCase()],
        }))
      : [],
  Pl = (e, o) =>
    e.filter((t) => (t.enabledFor ? t.enabledFor.some((n) => n === o) : !0));
var kt = (e) => {
  let o = be(e),
    t = Io(),
    n = Ir(Fr, o, t),
...
var Et = (e) => {
  let o = S(H),
    t = _e(e.files.associations),
    n = [o, ...t],
    r = ce(e);
  for (let s of n) {
    let a = (0, pe.readdirSync)(s).filter((i) => i.match(/\.svg/gi));
    for (let i of a) {
      let l = (0, wt.join)(s, i),
        c = (0, wt.join)(
          s,
          i.replace(/(^[^\.~]+).*?(\.clone\.svg|\.svg)/, `$1${r}$2`),
        );
      try {
        l !== c &&
          ((0, pe.existsSync)(c)
            ? (0, pe.existsSync)(l) &&
              (y.debug(`Deleting existing file: ${l}`), (0, pe.unlinkSync)(l))
            : (0, pe.existsSync)(l) &&
              (y.debug(`Renaming file: ${l} to ${c}`),
              (0, pe.renameSync)(l, c)));
      } catch (f) {
        y.error(f);
      }
...
var Ar = Object.values(bt);
var Po = (e) => e.charAt(0).toUpperCase() + e.slice(1),
  Ke = (e) =>
    e
      .split(" ")
...
var Pr = {
  ...
  opacity: {
    inputPlaceholder:
      "\u0642\u064A\u0645\u0629 \u0627\u0644\u0634\u0641\u0627\u0641\u064A\u0629 (\u0628\u064A\u0646 0 \u0648 1)",
    wrongValue:
      "\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0631\u0642\u0645 \u0639\u0634\u0631\u064A \u0628\u064A\u0646 0 \u0648 1.",
  },
  toggleSwitch: {
    on: "\u062A\u0634\u063A\u064A\u0644",
    off: "\u0625\u064A\u0642\u0627\u0641",
  ...
  explorerArrows: {
    toggle:
      "\u062A\u0628\u062F\u064A\u0644 \u0623\u0633\u0647\u0645 \u0627\u0644\u0645\u062C\u0644\u062F\u0627\u062A \u0641\u064A \u0627\u0644\u0645\u0633\u062A\u0643\u0634\u0641",
    enable:
      "\u0625\u0638\u0647\u0627\u0631 \u0623\u0633\u0647\u0645 \u0627\u0644\u0645\u062C\u0644\u062F\u0627\u062A \u0641\u064A \u0627\u0644\u0645\u0633\u062A\u0643\u0634\u0641",
    disable:
      "\u0625\u062E\u0641\u0627\u0621 \u0623\u0633\u0647\u0645 \u0627\u0644\u0645\u062C\u0644\u062F\u0627\u062A \u0641\u064A \u0627\u0644\u0645\u0633\u062A\u0643\u0634\u0641",
  },
  grayscale: {
    toggle:
      "\u062A\u0628\u062F\u064A\u0644 \u0627\u0644\u0623\u064A\u0642\u0648\u0646\u0627\u062A \u0627\u0644\u0631\u0645\u0627\u062F\u064A\u0629",
    enable:
      "\u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0623\u064A\u0642\u0648\u0646\u0627\u062A \u0627\u0644\u0631\u0645\u0627\u062F\u064A\u0629",
    disable:
      "\u062A\u0639\u0637\u064A\u0644 \u0627\u0644\u0623\u064A\u0642\u0648\u0646\u0627\u062A \u0627\u0644\u0631\u0645\u0627\u062F\u064A\u0629",
  },
  saturation: {
    inputPlaceholder:
      "\u0642\u064A\u0645\u0629 \u0627\u0644\u062A\u0634\u0628\u0639 (\u0628\u064A\u0646 0 \u0648 1)",
    wrongValue:
      "\u064A\u0631\u062C\u0649 \u0625\u062F\u062E\u0627\u0644 \u0631\u0642\u0645 \u0639\u0634\u0631\u064A \u0628\u064A\u0646 0 \u0648 1.",
  },
};
var zr = {
  ...
  folders: {
    ...
    theme: { description: "Vyberte motiv slo\u017Eky '%0'" },
  },
  colorSelect: {
    color: "Vyberte barvu",
  ...
  toggleSwitch: { on: "ZAPNUTO", off: "VYPNUTO" },
  explorerArrows: {
...
var _r = {
  ...
  folders: {
    ...
    theme: { description: "W\xE4hle das '%0' Design" },
  },
  colorSelect: {
...
var Dr = {
  ...
  folders: {
    ...
    theme: { description: "Ic\xF4nes de dossiers '%0'" },
  },
  colorSelect: {
...
var $r = {
  ...
  folders: {
    ...
    theme: { description: "Pilih tema folder '%0'" },
  },
  colorSelect: {
    color: "Pilih warna",
  ...
  toggleSwitch: { on: "AKTIF", off: "NONAKTIF" },
  explorerArrows: {
...
var Lr = {
  activate: "Attiva",
  activated: "Material Icon Theme \xE8 attivo.",
  iconPacks: {
  ...
  folders: {
    ...
    theme: { description: "Seleziona il tema cartelle '%0'" },
  },
  colorSelect: {
  ...
  opacity: {
    inputPlaceholder: "Valore opacit\xE0 (tra 0 e 1)",
...
var Mr = {
  ...
  folders: {
    ...
    disabled: "\uD3F4\uB354 \uC544\uC774\uCF58 \uC5C6\uC74C",
    theme: { description: "'%0' \uD3F4\uB354 \uD14C\uB9C8 \uC120\uD0DD" },
  },
  colorSelect: {
    color: "\uC0C9\uC0C1 \uC120\uD0DD",
    hexCode: "HEX \uC0C9\uC0C1 \uCF54\uB4DC \uC785\uB825",
    wrongHexCode:
      "\uC720\uD6A8\uD558\uC9C0 \uC54A\uC740 HEX \uC0C9\uC0C1 \uCF54\uB4DC\uC785\uB2C8\uB2E4!",
  },
  opacity: {
    inputPlaceholder: "\uD22C\uBA85\uB3C4 \uAC12 (0\uACFC 1 \uC0AC\uC774)",
    wrongValue:
      "0\uACFC 1 \uC0AC\uC774\uC758 \uBD80\uB3D9 \uC18C\uC218\uC810 \uC22B\uC790\uB97C \uC785\uB825\uD558\uC138\uC694.",
  },
  toggleSwitch: { on: "\uCF1C\uC9D0", off: "\uAEBC\uC9D0" },
  explorerArrows: {
    toggle:
      "\uD30C\uC77C \uD0D0\uC0C9\uAE30\uC758 \uD3F4\uB354 \uD654\uC0B4\uD45C \uC124\uC815",
    enable:
...
var Br = {
  ...
  folders: {
    ...
    theme: { description: "Wybierz motyw folder\xF3w '%0'" },
  },
  colorSelect: {
    color: "Wybierz kolor",
  ...
  opacity: {
    inputPlaceholder:
      "Warto\u015B\u0107 przezroczysto\u015Bci (pomi\u0119dzy 0 a 1)",
...
var Vr = {
  ...
  folders: {
    ...
    theme: { description: "Seleccionar o tema para direct\xF3rios '%0'" },
  },
  colorSelect: {
...
var qr = {
  ...
  iconPacks: {
    ...
    description:
      "\u0412\u044B\u0431\u0440\u0430\u0442\u044C '%0' \u043D\u0430\u0431\u043E\u0440 \u0438\u043A\u043E\u043D\u043E\u043A",
    disabled:
      "\u0412\u044B\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u043D\u0430\u0431\u043E\u0440 \u0438\u043A\u043E\u043D\u043E\u043A",
  },
  folders: {
    toggleIcons:
      "\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u0442\u0435\u043C\u0443 \u043F\u0430\u043F\u043A\u0438",
    disabled:
      "\u041D\u0435\u0442 \u0438\u043A\u043E\u043D\u043E\u043A \u0434\u043B\u044F \u043F\u0430\u043F\u043A\u0438",
    theme: {
      description:
        "\u0412\u044B\u0431\u0440\u0430\u0442\u044C '%0' \u0442\u0435\u043C\u0443 \u043F\u0430\u043F\u043A\u0438",
    },
  },
  colorSelect: {
    color:
      "\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0446\u0432\u0435\u0442",
    hexCode:
      "\u0412\u0441\u0442\u0430\u0432\u0438\u0442\u044C HEX-\u043A\u043E\u0434 \u0446\u0432\u0435\u0442\u0430",
    wrongHexCode:
      "\u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 HEX-\u043A\u043E\u0434 \u0446\u0432\u0435\u0442\u0430!",
  },
  opacity: {
    inputPlaceholder:
      "\u0417\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u043D\u0435\u043F\u0440\u043E\u0437\u0440\u0430\u0447\u043D\u043E\u0441\u0442\u0438 (\u043C\u0435\u0436\u0434\u0443 0 \u0438 1)",
    wrongValue:
  ...
  explorerArrows: {
    toggle:
      "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C/\u0441\u043A\u0440\u044B\u0442\u044C \u0441\u0442\u0440\u0435\u043B\u043A\u0438 \u0443 \u043F\u0430\u043F\u043E\u043A",
    enable:
      "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0441\u0442\u0440\u0435\u043B\u043A\u0438 \u0443 \u043F\u0430\u043F\u043E\u043A",
    disable:
      "\u0421\u043A\u0440\u044B\u0442\u044C \u0441\u0442\u0440\u0435\u043B\u043A\u0438 \u0443 \u043F\u0430\u043F\u043E\u043A",
  },
  grayscale: {
    toggle:
      "\u041F\u0435\u0440\u0435\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u0435 \u0441\u0435\u0440\u044B\u0445 \u0437\u043D\u0430\u0447\u043A\u043E\u0432",
    enable:
      "\u0412\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u0437\u043D\u0430\u0447\u043A\u0438 \u0432 \u043E\u0442\u0442\u0435\u043D\u043A\u0430\u0445 \u0441\u0435\u0440\u043E\u0433\u043E",
    disable:
      "\u041E\u0442\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u0437\u043D\u0430\u0447\u043A\u0438 \u0432 \u043E\u0442\u0442\u0435\u043D\u043A\u0430\u0445 \u0441\u0435\u0440\u043E\u0433\u043E",
  },
  saturation: {
    inputPlaceholder:
      "\u0417\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u043D\u0430\u0441\u044B\u0449\u0435\u043D\u043D\u043E\u0441\u0442\u0438 (\u043C\u0435\u0436\u0434\u0443 0 \u0438 1)",
    wrongValue:
      "\u0417\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u0434\u043E\u043B\u0436\u043D\u043E \u0431\u044B\u0442\u044C \u043C\u0435\u0436\u0434\u0443 0 \u0438 1!",
  },
};
var Hr = {
  activate: "\u0410\u043A\u0442\u0438\u0432\u0443\u0432\u0430\u0442\u0438",
  activated:
    "Material Icon Theme \u0430\u043A\u0442\u0438\u0432\u043E\u0432\u0430\u043D\u0438\u0439.",
  iconPacks: {
    selectPack:
      "\u0412\u0438\u0431\u0435\u0440\u0456\u0442\u044C \u043D\u0430\u0431\u0456\u0440 \u0456\u043A\u043E\u043D\u043E\u043A",
    description:
      "\u0412\u0438\u0431\u0435\u0440\u0456\u0442\u044C \u043D\u0430\u0431\u0456\u0440 \u0437\u043D\u0430\u0447\u043A\u0456\u0432 '%0'",
    disabled:
      "\u0412\u0438\u043C\u043A\u043D\u0443\u0442\u0438 \u043F\u0430\u043A\u0435\u0442\u0438 \u0437\u043D\u0430\u0447\u043A\u0456\u0432",
  },
  folders: {
    toggleIcons:
      "\u041F\u0435\u0440\u0435\u043A\u043B\u044E\u0447\u0438\u0442\u0438 \u0442\u0435\u043A\u0443 icons",
    disabled:
      "\u041D\u0435\u043C\u0430\u0454 \u043F\u0456\u043A\u0442\u043E\u0433\u0440\u0430\u043C \u043F\u0430\u043F\u043E\u043A",
    theme: {
      description:
        "\u0412\u0438\u0431\u0435\u0440\u0456\u0442\u044C \u0442\u0435\u043C\u0443 \u043F\u0430\u043F\u043A\u0438 '%0'",
    },
  },
  colorSelect: {
    color:
      "\u0412\u0438\u0431\u0435\u0440\u0456\u0442\u044C \u043A\u043E\u043B\u0456\u0440",
    hexCode:
      "\u0412\u0432\u0435\u0434\u0456\u0442\u044C HEX \u043A\u043E\u043B\u0456\u0440\u043D\u0438\u0439 \u043A\u043E\u0434",
    wrongHexCode:
      "\u041D\u0435\u0434\u0456\u0439\u0441\u043D\u0438\u0439 HEX \u043A\u043E\u043B\u0456\u0440\u043D\u0438\u0439 \u043A\u043E\u0434!",
  },
  opacity: {
    inputPlaceholder:
      "\u0417\u043D\u0430\u0447\u0435\u043D\u043D\u044F \u043D\u0435\u043F\u0440\u043E\u0437\u043E\u0440\u043E\u0441\u0442\u0456 (\u0432\u0456\u0434 0 \u0434\u043E 1)",
    wrongValue:
      "\u0417\u043D\u0430\u0447\u0435\u043D\u043D\u044F \u043C\u0430\u0454 \u0431\u0443\u0442\u0438 \u0432\u0456\u0434 0 \u0434\u043E 1!",
  },
  toggleSwitch: {
    on: "\u0412\u043A\u043B\u044E\u0447\u0438\u0442\u0438",
    off: "\u0412\u0456\u0434\u043A\u043B\u044E\u0447\u0438\u0442\u0438",
  ...
  explorerArrows: {
    toggle:
      "\u0421\u0442\u0440\u0456\u043B\u043A\u0438 \u0434\u043B\u044F \u043F\u0435\u0440\u0435\u043C\u0438\u043A\u0430\u043D\u043D\u044F \u043F\u0430\u043F\u043E\u043A",
    enable:
      "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u0438 \u0441\u0442\u0440\u0456\u043B\u043A\u0438 \u043F\u0430\u043F\u043A\u0438",
    disable:
      "\u041F\u0440\u0438\u0445\u043E\u0432\u0430\u0442\u0438 \u0441\u0442\u0440\u0456\u043B\u043A\u0438 \u043F\u0430\u043F\u043A\u0438",
  },
  grayscale: {
    toggle:
      "\u041F\u0435\u0440\u0435\u043C\u0438\u043A\u0430\u043D\u043D\u044F \u0437\u043D\u0430\u0447\u043A\u0456\u0432 \u0443 \u0432\u0456\u0434\u0442\u0456\u043D\u043A\u0430\u0445 \u0441\u0456\u0440\u043E\u0433\u043E",
    enable:
      "\u0423\u0432\u0456\u043C\u043A\u043D\u0443\u0442\u0438 \u0437\u043D\u0430\u0447\u043A\u0438 \u0443 \u0432\u0456\u0434\u0442\u0456\u043D\u043A\u0430\u0445 \u0441\u0456\u0440\u043E\u0433\u043E",
    disable:
      "\u0412\u0438\u043C\u043A\u043D\u0443\u0442\u0438 \u0437\u043D\u0430\u0447\u043A\u0438 \u0443 \u0432\u0456\u0434\u0442\u0456\u043D\u043A\u0430\u0445 \u0441\u0456\u0440\u043E\u0433\u043E",
  },
  saturation: {
    inputPlaceholder:
      "\u0417\u043D\u0430\u0447\u0435\u043D\u043D\u044F \u043D\u0430\u0441\u0438\u0447\u0435\u043D\u043D\u044F (\u0432\u0456\u0434 0 \u0434\u043E 1)",
    wrongValue:
      "\u0417\u043D\u0430\u0447\u0435\u043D\u043D\u044F \u043C\u0430\u0454 \u0431\u0443\u0442\u0438 \u0432\u0456\u0434 0 \u0434\u043E 1!",
  },
};
...
var Yr,
  ...
  vt = async (e) => {
    try {
      ((Yr = await Xr(e)),
        (Zr = await Xr("en")),
        y.info("Translations initialized."));
    } catch (o) {
      y.error(o);
    }
  },
  ...
  _l = (e, o = Yr, t = Zr) => {
    var n;
    return (n = oo(o, e)) != null ? n : oo(t, e);
  },
  A = (e, ...o) => {
    let t = _l(e);
    return o.length === 0 ? (t != null ? t : e) : Tl(t, ...o);
  },
  Tl = (e = "", ...o) => {
    let t = e;
    return (
...
var Jr = require("vscode");
var zo = require("vscode");
var ze = (e) => zo.workspace.getConfiguration(e),
  Nt = () => {
    var e, o, t, n;
    return (n =
      (t =
        (o =
          (e = zo.extensions.getExtension(`${Mo}.${W}`)) == null
            ? void 0
            : e.packageJSON) == null
          ? void 0
          : o.contributes) == null
  ...
  Dl = Object.keys(Nt()),
  Kr = (e, o, t = !1) => ze().update(e, o, t),
  L = (e) => {
    let o = ze(W).inspect(e);
    return $l(o);
  },
  q = (e, o, t = !1) => ze(W).update(e, o, t);
var $l = (e) => {
    var t, n;
    let o;
    if (e !== void 0)
      return (
        typeof e.workspaceValue == "object" && e.workspaceValue && e.globalValue
          ? (o = _(e.workspaceValue, e.globalValue))
          : (o =
              (n = (t = e.workspaceValue) != null ? t : e.globalValue) != null
                ? n
                : e.defaultValue),
        o
      );
...
var _o,
  es = () => {
    var n, r;
    let e = (n = L("logLevel")) != null ? n : "info",
      o = (r = L("enableLogging")) != null ? r : !1,
      t;
    (o && (t = Jr.window.createOutputChannel(Ke(W.replaceAll("-", " ")))),
      (_o = So(e, (s) => {
        t ? t.appendLine(s.message) : console.log(s.message);
      })));
  },
  os = () => {
    _o && (_o.dispose(), (_o = void 0));
  };
var rs = require("fs"),
  ss = require("path"),
  as = Bs(ns());
var Ct = async (e, o) => {
    if ((e == null ? void 0 : e.affectsConfiguration(W)) === !1) return;
    let t = Sl(o),
      n = Ur();
    if ((0, as.default)(n, t))
      if (e === void 0 && Ao(n) && !(0, rs.existsSync)(S("./../icons/clones")))
        y.info("Custom clones missing from disk, regenerating...");
      else return;
    (await Xo(n, t), y.info("Configuration changes detected and applied!"));
    try {
      await Et(n);
    } catch (i) {
      y.error(i);
    ...
    let r = kt(n);
    await Qo(Ao(n));
    let s = _(r, await ht(r, n)),
      a = (0, ss.join)(S(Oo));
    (await ae(a, JSON.stringify(s, void 0, 2), "utf-8"),
      y.info("Updated the manifest file."),
      y.debug("Applied configuration: " + JSON.stringify(n, void 0, 2)),
      Ll(n, o));
  },
  Ll = (e, o) => {
    o.globalState.update("config", {
      version: o.extension.packageJSON.version,
      config: e,
    });
  },
  Sl = (e) => {
    let o = e.globalState.get("config");
    return e.extension.packageJSON.version === (o == null ? void 0 : o.version)
      ? be(o == null ? void 0 : o.config)
      : be();
  };
var Is = require("vscode");
var is = require("vscode");
var ls = () => Ml(),
  Ml = async () => {
    var e;
    try {
      let o = "workbench.iconTheme";
      (await ze().update(o, W, !0),
        (e = ze().inspect(o)) != null && e.workspaceValue && ze().update(o, W),
        is.window.showInformationMessage(A("activated")));
    } catch (o) {
      y.error(o);
    }
  };
var cs = require("vscode");
var ms = async () => {
    try {
      let e = Rl(),
        o = await Ol(e);
  ...
  Ol = (e) => {
    let o = {
        description: A("toggleSwitch.on"),
        detail: A("explorerArrows.enable"),
        label: e ? "\u25FB" : "\u2714",
      },
      t = {
        description: A("toggleSwitch.off"),
        detail: A("explorerArrows.disable"),
        label: e ? "\u2714" : "\u25FB",
      };
    return cs.window.showQuickPick([o, t], {
      placeHolder: A("explorerArrows.toggle"),
      ignoreFocusOut: !1,
      matchOnDescription: !0,
    });
  },
  Bl = (e) => {
    if (e != null && e.description)
      switch (e.description) {
        case A("toggleSwitch.on"):
          return q("hidesExplorerArrows", !1, !0);
        case A("toggleSwitch.off"):
          return q("hidesExplorerArrows", !0, !0);
        default:
          return;
      }
  },
  Rl = () => L("hidesExplorerArrows") === !0;
var Ft = require("vscode");
var It = [
  ...
  Vl = (e) => {
    ...
    return Ft.window.showQuickPick(o, {
      placeHolder: A("colorSelect.color"),
      ignoreFocusOut: !1,
      matchOnDescription: !0,
    });
  },
  ql = async (e) => {
    var o;
    if (!(!e || !e.description))
      if (e.description === "Custom Color") {
        let t = await Ft.window.showInputBox({
          placeHolder: A("colorSelect.hexCode"),
          ignoreFocusOut: !0,
          validateInput: Hl,
        });
        t && fs(t);
        ...
        let t =
          (o = It.find((n) => n.label === e.description)) == null
            ? void 0
            : o.hex;
        t && fs(t);
      }
  ...
  Hl = (e) => {
    if (!me(e)) return A("colorSelect.wrongHexCode");
  },
  Gl = () => {
    var o;
    let e = Y();
    return (o = L("files.color")) != null ? o : e.files.color;
  },
  fs = (e) => {
    q("files.color", e.toLowerCase(), !0);
  },
  Wl = (e, o) =>
    e.label === "Custom Color"
      ? !It.some((t) => t.hex.toLowerCase() === o.toLowerCase())
      : e.hex.toLowerCase() === o.toLowerCase();
var At = require("vscode");
var Pt = [
    { label: "Grey (Default)", hex: "#90a4ae" },
    { label: "Blue", hex: "#42a5f5" },
    { label: "Green", hex: "#7CB342" },
  ...
  zt = (e) => {
    ...
    return At.window.showQuickPick(o, {
      placeHolder: A("colorSelect.color"),
      ignoreFocusOut: !1,
      matchOnDescription: !0,
    });
  ...
  _t = async (e, o) => {
    ...
    if (!(!e || !e.description))
      if (e.description === "Custom Color") {
        let n = await At.window.showInputBox({
          placeHolder: A("colorSelect.hexCode"),
          ignoreFocusOut: !0,
          validateInput: Xl,
        });
        ...
        let n =
          (t = Pt.find((r) => r.label === e.description)) == null
            ? void 0
            : t.hex;
        n && ps(n, o);
      }
  ...
  Ql = () => {
    let e = Y(),
      o = L("folders.color");
    return o != null ? o : e.folders.color;
  },
  ps = (e, o) => {
    q(o, e.toLowerCase(), !0);
  },
  Yl = (e, o) =>
    e.label === "Custom Color"
      ? !Pt.some((t) => t.hex.toLowerCase() === o.toLowerCase())
      : e.hex.toLowerCase() === o.toLowerCase();
var us = require("vscode");
var hs = async () => {
    try {
      let e = Ul(),
        o = await Zl(e);
  ...
  Zl = (e) => {
    let o = Ze.map((t) => ({
      description: Po(t.name),
      detail:
        t.name === "none"
          ? A("folders.disabled")
          : A("folders.theme.description", Po(t.name)),
      label: t.name === e ? "\u2714" : "\u25FB",
    }));
    return us.window.showQuickPick(o, {
      placeHolder: A("folders.toggleIcons"),
      ignoreFocusOut: !1,
      matchOnDescription: !0,
    });
  },
  Kl = (e) => {
    if (!(!e || !e.description))
      return q("folders.theme", e.description.toLowerCase(), !0);
  },
  Ul = () => {
    var e;
    return (e = L("folders.theme")) != null ? e : "none";
  };
var bs = require("vscode");
var xs = async () => {
    try {
      let e = oc(),
        o = await Jl(e);
  ...
  Jl = (e) => {
    let o = {
        description: A("toggleSwitch.on"),
        detail: A("grayscale.enable"),
        label: e ? "\u2714" : "\u25FB",
      },
      t = {
        description: A("toggleSwitch.off"),
        detail: A("grayscale.disable"),
        label: e ? "\u25FB" : "\u2714",
      };
    return bs.window.showQuickPick([o, t], {
      placeHolder: A("grayscale.toggle"),
      ignoreFocusOut: !1,
      matchOnDescription: !0,
    });
  },
  ec = (e) => {
    if (!(!e || !e.description))
      switch (e.description) {
        case A("toggleSwitch.on"):
          return q("saturation", 0, !0);
        case A("toggleSwitch.off"):
          return q("saturation", 1, !0);
        default:
          return;
      }
  },
  oc = () => L("saturation") === 0;
var ys = require("vscode");
var ks = async () => {
    try {
      let e = rc(),
        o = await tc(e);
  ...
  tc = (e) => {
    let t = [...Ar.sort(), "none"].map((n) => {
      let r = Ke(n.replace("_", " + ")),
        s = sc(e, n),
        a = n === "none" && e === "";
      return {
        description: r,
        detail: A(`iconPacks.${n === "none" ? "disabled" : "description"}`, r),
        label: a || s ? "\u2714" : "\u25FB",
      };
    });
    return ys.window.showQuickPick(t, {
      placeHolder: A("iconPacks.selectPack"),
      ignoreFocusOut: !1,
      matchOnDescription: !0,
      matchOnDetail: !0,
    });
  ...
  nc = (e) => {
    ...
    let o = e.description.replace(" + ", "_").toLowerCase();
    q("activeIconPack", o === "none" ? "" : o, !0);
  },
  rc = () => {
    var e;
    return (e = L("activeIconPack")) != null ? e : "";
  },
  sc = (e, o) => e.toLowerCase() === o.toLowerCase();
var ws = require("vscode");
var Es = async () => {
    try {
      let e = lc(),
        o = await ac(e);
  ...
  ac = (e) =>
    ws.window.showInputBox({
      placeHolder: A("opacity.inputPlaceholder"),
      ignoreFocusOut: !0,
      value: e.toString(),
      validateInput: ic,
    }),
  ic = (e) => {
    if (!ro(+e)) return A("opacity.wrongValue");
  },
  lc = () => {
    var o;
    let e = Y();
    return (o = L("opacity")) != null ? o : e.opacity;
  },
  cc = (e) => q("opacity", e, !0);
var js = async () => {
  let e = Object.keys(Nt());
  await Promise.all(e.map((o) => Kr(o, void 0, !0)));
};
var vs = async () => {
    try {
      let e = mc(),
        o = await zt(e);
      o && _t(o, "rootFolders.color");
    } catch (e) {
      y.error(e);
    }
  },
  mc = () => {
    ...
    let e = Y(),
      o = L("folders.color"),
      t = L("rootFolders.color");
    return (n = t != null ? t : o) != null ? n : e.folders.color;
  };
var Ns = require("vscode");
var Cs = async () => {
    try {
      let e = pc(),
        o = await fc(e);
  ...
  fc = (e) =>
    Ns.window.showInputBox({
      placeHolder: A("saturation.inputPlaceholder"),
      ignoreFocusOut: !0,
      value: e.toString(),
      validateInput: dc,
    }),
  dc = (e) => {
    if (!so(+e)) return A("saturation.wrongValue");
  },
  pc = () => {
    var o;
    let e = Y();
    return (o = L("saturation")) != null ? o : e.saturation;
  },
  gc = (e) => q("saturation", e, !0);
var Fs = {
    activateIcons: ls,
    toggleIconPacks: ks,
    changeFolderTheme: hs,
    changeFolderColor: gs,
    changeRootFolderColor: vs,
    changeFileColor: ds,
    restoreDefaultConfig: js,
    toggleExplorerArrows: ms,
    changeOpacity: Es,
    toggleGrayscale: xs,
    changeSaturation: Cs,
  },
  As = Object.keys(Fs).map((e) => {
    let o = () => Fs[e]();
    return Is.commands.registerCommand(`${W}.${e}`, o);
  });
var uc = async (e) => {
    try {
      (es(),
        await vt(To.env.language),
        e.subscriptions.push(...As),
        await Ct(void 0, e),
        e.subscriptions.push(
          To.workspace.onDidChangeConfiguration(async (o) => await Ct(o, e)),
        ),
        y.info("Extension activated!"));
    } catch (o) {
      y.error(o);
    }
  },
